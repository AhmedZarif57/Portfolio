...
import {
  ...
  o as f,
  l as v,
} from "./entry.06ae7dd6.js";
import { d as g, h as w, l as y, L as b } from "./loader-globals.d8a67046.js";
import { g as x, s as S } from "./globals.bade40a1.js";
import { s as T, d as A } from "./store.4d67c1b5.js";
import { L as _, g as k } from "./LoaderMixin.13fbd445.js";
import {
  g as C,
  S as L,
  p as P,
  ...
  q as J,
  r as ee,
} from "./custom-material.8570572a.js";
import {
  C as te,
  b as se,
  e as ie,
...
import { D as ae, x as re } from "./dom-component.59802661.js";
import {
  ai as le,
  a8 as pe,
  x as ce,
  ...
  aO as Mt,
  aP as Rt,
} from "./three.module.c9112413.js";
import { R as It } from "./index.d22011ff.js";
import { T as Et } from "./three-object.b70b8d57.js";
import { L as Ot, C as Ft } from "./constants.a4ba8ea6.js";
import { a as Dt, g as Bt, t as Ut } from "./index-default.25f36e61.js";
import {
  m as jt,
  w as Nt,
  l as zt,
  d as $t,
  a as Ht,
} from "./MathUtils.08fed4e9.js";
import { i as Gt, a as Xt } from "./gozer-env.ed057cb2.js";
import {
  a as Vt,
  b as Yt,
  c as Kt,
  ...
  m as qt,
  d as Zt,
} from "./simple-three.1b842056.js";
import { p as Qt } from "./number-pad.7e255fcb.js";
import { r as Jt } from "./resize-observer.8438de8e.js";
import { l as es } from "./lerp.a6fc2763.js";
import { W as ts, p as ss, g as is, u as os } from "./tweakpane.c9bbc2ba.js";
import { r as ns } from "./random-int.6625ac30.js";
import { m as as } from "./modulo.a5a4be50.js";
import { C as rs, g as ls } from "./camera.17fed500.js";
import { g as ps, a as cs, b as hs, S as ds } from "./rotate.292a5b70.js";
import { g as us } from "./drawing.d211013c.js";
import { D as ms } from "./dom-element.35f09cfb.js";
import { i as fs } from "./in-range.d69fbb78.js";
...
class gs extends te {
  ...
  async onSetup() {
    ...
    const c = o ?? new ce({ color: s, side: t });
    let h;
    if (n)
      h = L.pointsToStroke(a.currentPath.getPoints(), { strokeWidth: 0.1 });
    else {
    ...
    (this.vSize = new de()),
      ...
      h.boundingBox.getSize(this.vSize);
    const d = new ue(h, c);
    d.position.set(-l[0] / 2, -l[1] / 2, 0),
      d.layers.set(e),
      p.add(d),
      this.object.add(p);
  }
  onDestroy() {
    this.group.traverse((e) => {
      var t, s;
      null == (t = e.material) || t.dispose(),
        null == (s = e.geometry) || s.dispose();
    });
  }
}
Dt(gs, [Et]);
class ws extends te {
  ...
  update() {
    const { delta: e } = It.getInstance(),
      { vw: t, vh: s } = T().state,
      { x: i, y: o } = this.pointer,
      { rotAngle: n, rotStrength: a, dir: r, easing: l } = this.props;
    ...
    (this.rx = me.damp(this.rx, h, l, e)),
      (this.ry = me.damp(this.ry, d, l, e)),
      this.object.rotation.set(this.rx, this.ry, 0);
  }
}
class ys extends te {
  constructor() {
    super(...arguments),
      t(this, "options", { name: "PersistentCard" }),
      t(this, "props", { rotStrength: 0 }),
      t(this, "rx", 0),
      t(this, "ry", 0),
      t(this, "tweenProps", {
        pX: 0,
  ...
  updateTweenProps() {
    (this.props.pX = this.tweenProps.pX),
      (this.props.pY = this.tweenProps.pY),
      (this.props.pZ = this.tweenProps.pZ),
      (this.props.rX = this.tweenProps.rX),
      (this.props.rY = this.tweenProps.rY),
      (this.props.rZ = this.tweenProps.rZ),
      (this.props.s = this.tweenProps.s),
      (this.props.rotStrength = this.tweenProps.rotStrength);
  }
  async onSetup() {
    (this.cardContainer = new fe()),
      this.object.add(this.cardContainer),
      (this.frontFace = await new gs().setup({
        options: {
      ...
      Gt ||
        (this.cardMotion = await new ws().setup({
          options: { object: this.cardContainer },
          props: {
...
const bs = ({
    ...
    n ||
      ...
      a.buffers.stencil.setFunc(r.ALWAYS, 1, 255),
      a.buffers.stencil.setOp(r.KEEP, r.KEEP, r.REPLACE),
      a.buffers.stencil.setClear(0),
      a.buffers.stencil.setLocked(!0)),
      void 0 !== e && s.layers.set(e),
      o && t.setRenderTarget(o),
      t.render(i, s);
  },
  xs = ({
    layer: e,
    ...
    n ||
      ...
      a.buffers.stencil.setFunc(r.EQUAL, 1, 255),
      a.buffers.stencil.setOp(r.KEEP, r.KEEP, r.KEEP),
      a.buffers.stencil.setLocked(!0)),
      void 0 !== e && s.layers.set(e),
      o && t.setRenderTarget(o),
      t.render(i, s);
  ...
  Ts = ((e = 0, t = 0, s = 1, i = 1, o = 0.05) => {
    const n = new ge();
    (e = -s / 2),
      (t = -i / 2),
      n.moveTo(e, t + o),
      n.lineTo(e, t + i - o),
      n.quadraticCurveTo(e, t + i, e + o, t + i),
      n.lineTo(e + s - o, t + i),
      n.quadraticCurveTo(e + s, t + i, e + s, t + i - o),
      n.lineTo(e + s, t + o),
      n.quadraticCurveTo(e + s, t, e + s - o, t),
      n.lineTo(e + o, t),
      n.quadraticCurveTo(e, t, e, t + o);
    return new we(n);
  })();
class As extends te {
  constructor() {
    super(...arguments),
      t(this, "options", { name: "BgPlane", color: "red", layer: Ot.BG }),
      t(this, "tweenProps", { pY: 0, s: 1 });
  }
  updateTweenProps() {
    (this.props.pY = this.tweenProps.pY), (this.props.s = this.tweenProps.s);
  }
  async onSetup() {
    const { layer: e, color: t } = this.options;
    (this.mesh = new ue(Ts, Vt(t))),
      this.object.add(this.mesh),
      this.mesh.layers.set(e);
  }
}
Dt(As, [Et]);
class _s extends te {
  constructor() {
    super(...arguments),
      t(this, "options", { name: "PersistentCardMask" }),
      t(this, "props", {
        counter: 0,
        active: !0,
        visible: !0,
      ...
      t(this, "onTlUpdate", () => {
        this.card.updateTweenProps(),
          this.bgPlanes.forEach((e) => {
            e.updateTweenProps();
          });
      });
  }
  async onSetup() {
    (this.tweens = {}),
      (this.scene = new ye()),
      (this.camera = new be(32, 1, 0.01, 100)),
      this.camera.position.set(0, 0, 4),
      this.setupCardContainer(),
      await this.setupCard(),
      await this.setupBgPlanes(),
      P("persistentCard", this.scene);
  }
  setupCardContainer() {
    (this.cardContainer = new fe()),
      this.scene.add(this.cardContainer),
      i.set(this.cardContainer.rotation, { y: M(90) }),
      i.set(this.cardContainer.scale, { x: 0.3, y: 0.3, z: 0.3 });
  }
  async setupCard() {
    this.card = await new ys().setup({
      options: { addTo: this.cardContainer },
      props: { active: () => this.props.active },
    });
  }
  async setupBgPlanes() {
    (this.bgContainer = new fe()),
      (this.bgContainer.visible = !1),
      this.scene.add(this.bgContainer),
      (this.bgPlanes = await Promise.all(
        new Array(3).fill().map((e, t) => {
          const s = t % 2 == 0 ? Ft.LAVENDER : Ft.DARK_LAVENDER;
          return new As().setup({
            options: { addTo: this.bgContainer, color: s },
            props: { s: 1 },
          });
        })
      ));
  ...
  setupTimelines() {
    ...
    let n, a, r, l;
    R("keep"), (this.tl = i.timeline({ onUpdate: this.onTlUpdate }));
    const { tl: p } = this,
      { vw: c, vh: h, vh100: d, scale: u } = T().state,
      m = "power3.inOut",
      [f, v] = Nt(0, this.camera),
      g = c / d > 1 ? 1.2 * f : 1.1 * v;
    if (e) {
      const { heroBounds: t } = e;
      (n = d), (a = (t.width / c) * f);
      const s = 0.5 * n;
      r = f / -2 + (t.left / c) * f + a / 2;
      const i = (t.top / d) * v;
      (l = v / 2 - i - a / 2),
        p.addLabel("projectIntro", e.props.start),
        p.fromTo(
          this.card.tweenProps,
          { s: g },
          { s: a, duration: n, ease: "sine.inOut" },
          "projectIntro"
        ),
        p.fromTo(
          this.card.tweenProps,
          { pX: 0, pY: 0, rY: 0, rotStrength: 0 },
          { rotStrength: 1, rY: M(-30), duration: s, ease: "sine.inOut" },
          "projectIntro"
        ),
        p.to(
          this.card.tweenProps,
          { pX: r, pY: l, rY: 0, duration: s, ease: "sine.inOut" },
          `projectIntro+=${s}`
        );
    }
    if (
      (t &&
        ((n = d),
        p.addLabel("storyFlip", t.props.start),
        p.to(
          this.card.tweenProps,
          { rX: -0.3, rZ: -0.05, duration: n / 2, ease: m },
          "storyFlip"
        ),
        p.to(
          this.card.tweenProps,
          { rX: 0, rZ: 0, duration: n / 2, ease: m },
          "storyFlip+=" + 0.5 * n
        ),
        p.to(
          this.card.tweenProps,
      ...
      const { heroBounds: e } = s;
      (n = d), (a = (e.width / c) * f);
      r = f / -2 + (e.left / c) * f + a / 2;
      const t = (e.top / d) * v;
      l = v / 2 - t - a / 2;
      const i = 0.4 * d;
      p.set(this.card.tweenProps, { s: g }),
        p.addLabel("collectionIn", s.props.start),
        p.to(
          this.card.tweenProps,
          { s: a, duration: 0.75 * d, ease: "power3.inOut" },
          "collectionIn"
        ),
        p.to(
          this.card.tweenProps,
        ...
        p.to(
          this.card.tweenProps,
          { rX: -0.3, duration: i, ease: "power1.inOut" },
          "collectionIn"
        ),
        p.to(
          this.card.tweenProps,
          { rX: 0, duration: i, ease: "power1.inOut" },
          `collectionIn+=${i}`
        );
    }
    if (o) {
      const e = 300 * u,
        t = Xt ? 0.75 : 1;
      p.addLabel("galleryIn", o.props.start),
        p.to(
          this.card.tweenProps,
          { s: t, rotStrength: 0, duration: e, ease: "power2.in" },
          "galleryIn"
        ),
        p.add(() => (this.card.props.v = !0), "+=1px"),
        p.add(() => (this.card.props.v = !1), "+=1px"),
        p.add(() => (this.bgContainer.visible = !1), "galleryIn-=1px"),
        p.add(() => (this.bgContainer.visible = !0), "galleryIn");
      const i = o.props.end + h;
      p.add(() => (this.bgContainer.visible = !0), i - 1),
        p.add(() => (this.bgContainer.visible = !1), i);
      const { heroBounds: r } = s;
      a = (r.width / c) * f;
      const m = (r.top / d) * v;
      (l = v / 2 - m - a / 2),
        this.bgPlanes.forEach((e, t) => {
          const s = Xt ? 0.6 : 0.8,
            i = (100 * t + 100) * u;
          (n = 300 * u),
            p.fromTo(
              e.tweenProps,
              { s: s, pY: l },
              { s: g, pY: 0, duration: n, ease: "power3.out" },
              `galleryIn+=${i}`
            );
        });
    }
    p.seek(0.001), this.options.tl.add(p, 0), this.onTlUpdate();
  }
  show({ delay: e = 0 }) {
    const t = "power3.inOut";
    i.to(this.cardContainer.rotation, { y: 0, duration: 3, delay: e, ease: t }),
  ...
  render() {
    ...
    const { renderer: e, orthoCamera: t } = It.getInstance();
    this.camera.layers.set(Ot.BG),
      e.render(this.scene, this.camera),
      this.camera.layers.set(Ot.MAIN);
  }
  resize({ width: e, height: t, height100vh: s }) {
...
const ks = ({ context: e }) => re` <div class="scrollIndicator type-caption3">
    <div
      data-ui="text"
...
class Cs extends te {
  constructor() {
    super(...arguments),
      t(this, "options", { template: ks, onClick: () => {} }),
      t(this, "props", { active: !1 }),
      t(this, "show", ({ delay: e = 0 } = {}) => {
        (this.props.active = !0),
          this.hackyText.show({ delay: e, speed: 1.5 }),
  ...
  async onSetup() {
    (this.lines = [this.ui.leftLine, this.ui.rightLin]),
      (this.hackyText = await new I().setup({ options: { el: this.ui.text } })),
      this.setupAnimation();
  }
  setupAnimation() {
    this.tl = i.timeline({ paused: !0, onComplete: this.onComplete });
    const e = "sine.out";
    this.tl.from(this.ui.leftLine, {
      ...
      this.tl.from(
        this.ui.rightLine,
        { x: 10, scaleX: 0, duration: 0.6, ease: e },
        0.05
      ),
      i.set(this.ui.leftLine, { scaleX: 1.5 }),
      i.set(this.ui.rightLine, { scaleY: 1.5 });
  }
  hide({ delay: e = 0 } = {}) {
    var t;
    (this.props.active = !1),
      this.tl.timeScale(2).reverse(),
      null == (t = this.delay) || t.kill(),
      this.hackyText.hide();
  }
  onDestroy() {
    var e;
...
Dt(Cs, [ae]);
const Ls = ({ options: e, context: t }) => re` <section
...
class Ps extends te {
  ...
  async onSetup() {
    (this.titles = this.el.querySelectorAll(".js-title")),
      (this.bodyCopy = await new I().setup({ options: { el: this.ui.body } })),
      Gt ||
        (this.scrollIndicator = await new Cs().setup({
          options: { appendTo: this.ui.inner },
        })),
  ...
  setupTimeline() {
    ...
    const e = (this.tl = i.timeline()),
      ...
      { vh: s } = T().state,
      o = 0.3 * s;
    e.add(() => (this.props.hideText = !1), o - 1),
      e.add(() => (this.props.hideText = !0), o),
      e.fromTo(this.ui.inner, { alpha: 1 }, { alpha: 0, duration: t }),
      e.seek(0.001),
      this.options.tl.add(e, 0);
  }
  show({ delay: e = 0 } = {}) {
    var t;
    const { scale: s } = T().state;
    i.fromTo(
      this.titles,
      { alpha: 0 },
      { alpha: 1, duration: 0.1, stagger: 0.1, delay: e }
    ),
      i.fromTo(
        this.titles,
        { x: -200 * s },
        { x: 0, duration: 2, delay: e, stagger: 0.1, ease: "expo.out" }
      );
    const o = this.bodyCopy.show({ delay: e, speed: 0.4 });
    null == (t = this.scrollIndicator) || t.show({ delay: e + 0.5 }),
      i.delayedCall(e, () => {
        this.sound.play(), i.delayedCall(o, () => this.sound.stop());
      });
  }
  offHideText({ firstTrigger: e }) {
    var t;
...
class Ms extends te {
  constructor() {
    super(...arguments),
      t(this, "options", { el: null, useScrollPos: !0 }),
      t(this, "props", { y: 0 }),
      t(this, "bounds", {
        height: 1,
        left: 0,
  ...
  resize({ offset: e = 0 } = {}) {
    const { scrollSmoother: t } = x,
      { useScrollPos: s } = this.options,
      i = s ? (t ? t.scrollTop() : T().state.scroll) : 0,
      {
        height: o,
        left: n,
        top: a,
      ...
      l = a + i,
      p = l - e;
    this.bounds = { height: o, left: n, width: r, top: l, topFromSection: p };
  }
}
const Rs = Xt ? {} : { backSide: `${O}project-intro/back-face.ktx2` },
  Is = Gt ? "-mobile" : "";
class Es extends te {
  constructor() {
    super(...arguments),
      t(this, "options", { id: "landing", useMasking: !0 }),
      t(this, "props", { active: !1, viewport: () => T().state.viewport }),
      t(this, "assets", {
        ...Rs,
  ...
  async onSetup() {
    await this.setupScene(),
      await this.setupCard(),
      P("projectIntroMedia", this.scene);
  }
  async setupScene() {
    (this.scene = new ye()),
      (this.bgObj = new fe()),
      this.scene.add(this.bgObj);
    const { backSide: e, frontSide: t } = this.assets;
    (this.envBack = new ue(Yt, Kt(e))),
      (this.envFront = new ue(Yt, Kt(t))),
      this.envBack.layers.set(0),
      this.envFront.layers.set(1),
      this.bgObj.add(this.envBack),
      this.bgObj.add(this.envFront);
  }
  async setupCard() {
    this.cardMask = await new Os().setup({
      options: { addTo: this.scene, layer: Ot.STENCIL },
      props: { active: () => this.props.active },
    });
  }
  setupTimeline() {
    this.tl && (this.options.tl.remove(this.tl), this.tl.kill());
    const e = (this.tl = i.timeline({ onUpdate: this.onTlUpdate })),
      { perspCamera: t } = It.getInstance(),
      { vw: s, vh: o, vh100: n } = T().state,
      { bounds: a } = this.options.boundingBox,
      [r, l] = Nt(0, t),
      p = o,
      c = (a.width / s) * r,
    ...
    e.addLabel("down", v),
      ...
      e.fromTo(
        ...
        { rY: 0, pX: d, pY: u, duration: f, ease: "sine.inOut" },
        "down"
      );
    const g = 0.5 * f;
    e.fromTo(
      this.cardMask.tweenProps,
      { pZ: 0 },
      { pZ: Xt ? 0 : -0.75, duration: g, ease: "sine.inOut" },
      "down"
    ),
      e.to(
        this.cardMask.tweenProps,
        { pZ: 0, duration: g, ease: "sine.inOut" },
        `down+=${g}`
      ),
      e.fromTo(
        this.bgObj.position,
        { x: 0, y: Xt ? -0.1 : 0 },
        { x: Xt ? 0 : d, y: Xt ? u : 0, duration: p, ease: "sine.inOut" },
        "down"
      ),
      e.addLabel("out", m.props.end - o),
      e.add(() => {
      ...
      e.to(
        this.cardMask.tweenProps,
        { rotStrength: 0, duration: 0.2 * o, ease: "power3.inOut" },
        "out"
      ),
      e.to(
        this.bgObj.position,
        { y: Xt ? 0.5 * l : 0.25 * l, duration: o, ease: "power3.inOut" },
        "out"
      ),
      e.seek(0.001),
      this.options.tl.add(e, 0);
  ...
  whileActive() {}
  render() {
    const { renderer: e, perspCamera: t } = It.getInstance(),
      { useMasking: s } = this.options;
    let i =
      this.cardMask.props.rY > 1.4
        ? 0
        : this.cardMask.props.rY < -1.85
        ? 100
        : 1;
    return (
      s
        ? (e.clearDepth(),
          e.clearStencil(),
          bs({ renderer: e, layer: Ot.STENCIL, camera: t, scene: this.scene }),
          xs({ renderer: e, layer: i, camera: t, scene: this.scene }),
          Ss(e))
        : (t.layers.set(i), e.render(this.scene, t)),
      null
    );
  }
  resize() {
  ...
  resizeBgObj() {
    const { perspCamera: e } = It.getInstance(),
      [t, s] = Nt(0, e),
      i = R("project-intro"),
      { width: o, height: n } = i.mediaBoundingBox.bounds,
      { vw: a, vh: r, vh100: l } = T().state;
    let p = 1.3 * o,
      c = p / 1;
    o / n < 1 && ((c = 1.3 * n), (p = 1 * c)),
      (p = (p / a) * t),
      (c = (c / r) * s),
      this.bgObj.scale.set(p, c);
  }
  onDestroy() {
    var e;
    null == (e = this.tl) || e.kill();
...
class Os extends te {
  ...
  async onSetup() {
    const { layer: e } = this.options;
    (this.tweens = { rolloverScale: 1 }),
      (this.innerObj = new fe()),
      ...
      Gt ||
        (this.cardMaskMotion = await new ws().setup({
          options: { object: this.innerObj },
          props: {
            rotStrength: () => this.props.rotStrength,
            dir: -1,
            active: () => this.props.active,
  ...
  setRollover(e) {
    const t = e ? 1.03 : 1;
    i.killTweensOf(this.tweens.rolloverScale),
      i.to(this.tweens, {
        rolloverScale: t,
        duration: 1.2,
        ease: "expo.out",
...
Dt(Es, [_()]), Dt(Os, [Et]);
const Fs = ({ context: e }) => re` <button class="btnPlay">
    <svg
      class="btnPlay__icon"
      data-ui="icon"
...
class Ds extends te {
  constructor() {
    super(...arguments),
      t(this, "options", { template: Fs, onClick: () => {} }),
      t(this, "props", { active: !1, rollover: !1 });
  }
  async onSetup() {
    (this.lines = [this.ui.ring, this.ui.play]), this.setupAnimation();
  }
  setupAnimation() {
    (this.tl = new i.timeline({ paused: !0 })),
      i.set(this.ui.play, { drawSVG: "0% 0%" }),
      i.set(this.ui.ring, { scale: 0, transformOrigin: "center" });
  }
  show({ delay: e = 0 } = {}) {
    (this.props.active = !0),
      i.killTweensOf(this.lines),
      i.to(this.ui.play, {
        drawSVG: "0% 100%",
        duration: 1,
        delay: e,
      ...
      i.to(this.ui.ring, { scale: 1, duration: 1, delay: e, ease: "expo.out" });
  }
  hide({ delay: e = 0 } = {}) {
    (this.props.active = !1),
      i.killTweensOf(this.lines),
  ...
  onRollover() {
    i.killTweensOf(this.lines),
      i.to(this.ui.ring, { scale: 1.1, duration: 1, ease: "expo.out" });
  }
  offRollover({ firstTrigger: e }) {
    e ||
      (i.killTweensOf(this.lines),
      i.to(this.ui.ring, { scale: 1, duration: 1, ease: "expo.out" }));
  }
}
Dt(Ds, [ae]);
const Bs = ({
...
class Us extends te {
  constructor() {
    super(...arguments),
      ...
      t(this, "props", { active: !1, showUi: !1 }),
  ...
  async onSetup() {
    Xt ||
      (this.ui.leftContainer.appendChild(this.ui.topLeft),
      this.ui.leftContainer.appendChild(this.ui.bottomLeft)),
      (this.lines = this.el.querySelectorAll(".js-line")),
      (this.heroBoundingBox = await new Ms().setup({
        options: { el: this.ui.hero, useScrollPos: !1 },
      })),
      (this.mediaBoundingBox = await new Ms().setup({
        options: { el: this.ui.media, useScrollPos: !1 },
      })),
      ...
      (this.btnPlay = await new Ds().setup({
        options: { appendTo: this.ui.media },
        props: { rollover: () => T().state.trailerVideoRollover },
      })),
      await this.setupTitle(),
      await this.setupCaptions(),
      this.waitForFonts();
  }
  waitForFonts() {
    this.stopEffect = se(
      () => this.title.props.fontLoaded,
      ({ firstTrigger: e }) => {
        this.setupTimeline();
      }
    );
  ...
  async setupCaptions() {
    this.options,
      (this.body = await new I().setup({
        options: { el: this.ui.description },
      })),
      (this.img1Caption = await new D().setup({
        options: { appendTo: this.ui.img1, text: "" },
      })),
      ...
      Xt &&
        (this.edenCaption = await new D().setup({
          options: {
  ...
  setupTimeline() {
    this.tl && (this.options.tl.remove(this.tl), this.tl.kill()),
      (this.animEls = [...this.title.lines, this.ui.img1]);
    const e = (this.tl = i.timeline()),
      { start: t, end: s } = this.props,
      { vh: o, scale: n } = T().state;
    let a = 0.4 * o;
    const r = o * (Xt ? 0.05 : 0.1);
    let l = this.props.start + 0.7 * o;
    e.addLabel("in", l),
      e.fromTo(this.body.el, { alpha: 0 }, { alpha: 1, duration: 0.2 * o }, l);
    const p = (t, s) => {
        e.fromTo(
          t,
          { y: r, alpha: 0 },
          { y: 0, alpha: 1, duration: a, ease: "power2.out" },
          s
        );
      },
      c = (t, s) => {
        e.to(t, { y: -r, alpha: 0, duration: a, ease: "power2.in" }, s);
      };
    ...
    const h = t + 0.95 * o,
      d = s - 0.8 * o;
    e.add(() => (this.props.showUi = !1), h - 1),
      e.add(() => (this.props.showUi = !0), h),
      e.add(() => (this.props.showUi = !0), d - 1),
      e.add(() => (this.props.showUi = !1), d),
      this.btnPlay &&
        e.fromTo(
          this.btnPlay.el,
          { alpha: 0 },
          { alpha: 1, duration: 0.05 * o },
          h - 0.05 * o
        ),
      e.fromTo(
        this.lines,
        { alpha: 0 },
        { alpha: 1, duration: 0.2 * o },
        t + 0.8 * o
      );
    let u = s - o;
    e.addLabel("out", u),
      e.to(this.body.el, { alpha: 0, duration: 0.2 * o }, u),
      this.animEls.forEach((e, t) => {
        const s = u + t * o * 0.05;
        c(e, s), t || c(this.title.caption.el, s);
      }),
      e.to(this.lines, { alpha: 0, duration: 0.3 * o }, u),
      this.btnPlay && e.to(this.btnPlay.el, { alpha: 0, duration: 0.1 * o }, u),
      Xt ||
        (this.btnPlay &&
          e.to(
            this.btnPlay.el,
            { y: 0.5 * -o, duration: o, ease: "power3.inOut" },
            u
          )),
      this.options.tl.add(e, 0);
  }
  onShowUi({ firstTrigger: e }) {
    var t, s;
    const i = 0.03;
    this.heroCaption.show({ delay: 0, stagger: i }),
      this.mediaCaption.show({ delay: 0.2, stagger: i }),
      null == (t = this.edenCaption) || t.show({ delay: 0.2, stagger: i }),
      null == (s = this.btnPlay) || s.show({ delay: 0.2 }),
      this.firstBodyShow || this.body.show({ speed: 0.5 }),
      (this.firstBodyShow = !0);
  }
  offShowUi({ firstTrigger: e }) {
    var t, s;
    if (e) return;
    const i = 0.005;
    this.heroCaption.hide({ stagger: i }),
      this.mediaCaption.hide({ stagger: i }),
      null == (t = this.edenCaption) || t.hide({ stagger: i }),
      this.img1Caption.hide({ stagger: i }),
  ...
  resize() {
    var e;
    this.title.props.fontLoaded && this.setupTimeline(),
      this.heroBoundingBox.resize({ offset: this.props.top }),
      this.mediaBoundingBox.resize({ offset: this.props.top }),
...
class Ns extends te {
  constructor() {
    super(...arguments),
      t(this, "options", { template: js, id: "project-story" }),
      t(this, "props", { active: !1, showHackyText: !1 });
  }
  async onSetup() {
    (this.lines = this.el.querySelectorAll(".js-line")),
      await this.setupTitles(),
      await this.setupCaptions(),
  ...
  async setupBoundingBox() {
    this.logoBoundingBox = await new Ms().setup({
      options: { el: this.ui.logoBoundingBox, useScrollPos: !1 },
    });
  }
  async setupTitles() {
    const { copy: e } = this.options;
  ...
  async setupCaptions() {
    const { copy: e } = this.options;
    Xt ||
      (this.logoCaption = await new D().setup({
        options: {
  ...
  async setupTerminalInfo() {
    Xt ||
      ((this.hackyCoords = await new I().setup({
        options: { el: this.ui.coords },
      })),
      (this.hackyTerminalinfo = await new I().setup({
        options: { el: this.ui.terminalInfo },
      })));
  }
  setupVideo() {
    ...
    const t = "/videos/project/topo-landing",
      s = `${t}.mp4`,
      i = `${t}.webm`;
    e.appendChild(j(`<source src="${s}" type='video/mp4; codecs="hvc1"' />`)),
      e.appendChild(j(`<source src="${i}" type="video/webm" />`)),
      this.ui.videoWrap.appendChild(this.video);
  }
  waitForFonts() {}
  onShowHackyText() {
    var e, t;
    null == (e = this.hackyTerminalinfo) || e.show({ speed: 0.6 }),
      null == (t = this.hackyCoords) || t.show({ speed: 0.6, delay: 0.2 });
  }
  offShowHackyText({ firstTrigger: e }) {
    var t;
  ...
  setupTimeline() {
    this.tl && (this.options.tl.remove(this.tl), this.tl.kill());
    const e = (this.tl = i.timeline({})),
      { vh: t, scale: s } = T().state,
      { bounds: o, top: n, start: a, end: r } = this.props,
      l = t,
      p = o.height + (Xt ? t : 0),
      c = l - p,
      h = t * (Xt ? 0.5 : 0.8),
      d = t * (Xt ? 0.03 : 0.05),
      u = Xt ? 20 : 30;
    e.fromTo(this.el, { y: l }, { y: c, duration: p, ease: "none" }, a),
      e.add(() => (this.props.showHackyText = !1), a + 0.6 * t - 1),
      e.add(() => (this.props.showHackyText = !0), a + 0.6 * t);
    const m = a + t * (Xt ? 0.6 : 0.5);
    if (
      (e.addLabel("title1In", m),
      this.title1.lines.forEach((t, s) => {
        const i = s * u,
          o = s * d;
        e.fromTo(
          t,
          { y: o },
          { y: 0, delay: i, duration: h, ease: "expo.out" },
          "title1In"
        ),
          e.fromTo(
            t,
            { alpha: 0 },
            { alpha: 1, delay: i, duration: 0.7 * h, ease: "sine.out" },
            "title1In"
          );
      }),
      e.fromTo(
        this.lines,
        { alpha: 0 },
        { alpha: 1, duration: 0.3 * t },
        "title1In"
      ),
      !Xt)
    ) {
      const s = a + t * (Xt ? 1.1 : 1.2);
      e.addLabel("title2In", s),
        this.title2.lines.forEach((t, s) => {
          const i = s * u,
            o = s * d;
          e.fromTo(
            t,
            { y: o, alpha: 0 },
            { y: 0, alpha: 1, delay: i, duration: h, ease: "expo.out" },
            "title2In"
          ),
            e.fromTo(
              t,
    ...
    e.to(this.lines, { alpha: 0, duration: 0.3 * t }, r - 0.8 * t),
      e.add(() => {
        var e;
  ...
  preResize() {
    (this.props.bounds.height = this.el.clientHeight),
      (this.options.triggerEl.style.height = `${this.props.bounds.height}px`),
      (this.el.style.transform = ""),
      this.logoBoundingBox.resize();
  }
  resize() {
    this.setupTimeline();
    const { width: e, height: t } =
        this.ui.diagLineBlock.getBoundingClientRect(),
      s = Math.atan(e / t) * (180 / Math.PI);
    this.ui.diagLineBlock.style.setProperty("--angle", -s + "deg");
  }
}
Dt(Ns, [E, ae]);
const zs = ({ options: e, props: t }) => re`<div class="collectionIntroCount">
    <h2
      data-ui="countText"
...
class $s extends te {
  ...
  async onSetup() {
    (this.tweens = { counterPr: 0, faceTraitsPr: 0 }),
      Jt().observe(this.options.container, (e) => {
        const { width: t } = e.contentRect;
        this.props.containerHeight = t;
      }),
      Jt().observe(this.el, (e) => {
        const { height: t } = e.contentRect;
        this.props.textHeight = t;
      });
  }
  offCountUp() {
    i.killTweensOf(this.tweens, "counterPr"),
      i.set(this.tweens, { counterPr: 0, onUpdate: this.handleCounterUpdate });
  }
  onCountUp() {
    i.to(this.tweens, {
      counterPr: 1,
...
class Gs extends te {
  constructor() {
    super(...arguments),
      t(this, "options", { template: Hs, id: "collection-intro" }),
      t(this, "props", { active: !1 }),
  ...
  async onSetup() {
    (this.tweens = { faceTraitsPr: 0 }),
      (this.lines = this.el.querySelectorAll(".js-line")),
      (this.heroBoundingBox = await new Ms().setup({
        options: { el: this.ui.hero, useScrollPos: !1 },
      })),
      await this.setupCount(),
      await this.setupCaptions(),
      Xt || (await this.setupCrystalVideo());
  }
  async setupCount() {
  ...
  async setupCaptions() {
    ...
    (this.videoCaption = await new D().setup({
      ...
      (this.bottomRightCaption = await new D().setup({
        options: { appendTo: this.ui.bottomRight, text: e.Image_Caption_2 },
      }));
  }
  async setupCrystalVideo() {
    this.crystalVideo = await new N().setup({
      ...
      props: { active: () => this.props.enter },
    });
  }
  setupTimeline() {
    this.tl &&
      (this.options.tl && this.options.tl.remove(this.tl), this.tl.kill());
    const { start: e, end: t } = this.props,
      { vh: s, scale: o } = T().state,
      n = (this.tl = i.timeline({})),
      a = 0.7 * s,
      r = e + 0.3 * s,
      l = e + 0.5 * s,
      p = t - s;
    n.fromTo(
      [this.ui.left, this.ui.right],
      { y: s, alpha: 1 },
      { y: 0, alpha: 1, duration: a, ease: "power3.out" },
      r
    ),
      n.fromTo(
        this.tweens,
      ...
      n.fromTo(
        this.lines,
        { alpha: 0 },
        { alpha: 1, duration: 200, ease: "expo.out" },
        e + s - 200
      ),
      n.add(() => {
        (this.count.props.countUp = !1),
          this.videoCaption.hide(),
          this.bottomRightCaption.hide();
      }, l - 1),
      n.add(() => {
        (this.count.props.countUp = !0),
          this.videoCaption.show(),
          this.bottomRightCaption.show();
      }, l),
      n.to(
        [this.ui.left, this.ui.right],
        { alpha: 0, y: Xt ? 0 : -50 * o, duration: 0.2 * s },
        p
      ),
      n.to(this.lines, { alpha: 0, duration: 0.2 * s }, p),
      n.seek(0.001),
      this.options.tl && this.options.tl.add(n, 0);
  }
  onEnter() {}
  offEnter() {}
  resize() {
    var e;
    this.ui.heroWrap.style.setProperty(
      "--height",
      `${this.ui.heroWrap.clientHeight}px`
    ),
      this.heroBoundingBox.resize(),
      null == (e = this.tl) || e.kill(),
      this.setupTimeline();
  }
  onDestroy() {
...
const Xs = {
  ...
  Vs = ({ options: e, props: t }) => re`<div class="collectionGallery">
    <img
      data-ui="arrowUp"
...
class Ys extends te {
  constructor() {
    super(...arguments),
      t(this, "options", { template: Vs, id: "collection-gallery" }),
      t(this, "props", {
        active: !1,
        loopCards: !1,
        index: 0,
        time: 0,
        timeline: null,
        nextItemDuration: Xt ? 1.6 : 0.8,
      }),
      t(this, "loopCards", () => {
        var e;
        const { nextItemDuration: t } = this.props;
        this.props.index++,
          null == (e = this.loopDelay) || e.kill(),
          (this.loopDelay = i.delayedCall(t, this.loopCards));
      }),
      t(this, "updateItems", (e) => {
        (this.props.active || e) &&
          (this.leftGroup.update(),
          this.rightGroup.update(),
          (this.props.loopCards =
            0 === this.tweens.outPr && this.tweens.inPr >= (Xt ? 0.8 : 0.4)));
      });
  }
  async onSetup() {
    (this.tweens = { inPr: 0, outPr: 0, outRotPr: 0, indexPr: 0 }),
  ...
  setupSounds() {
    ...
    ].map((e) => new Howl({ src: [e] }));
  }
  setBoundaries({ start: e, end: t }) {
    this.setupTimeline();
  }
  setupTimeline() {
    this.tl &&
      (this.options.tl && this.options.tl.remove(this.tl), this.tl.kill());
    const { start: e, end: t } = this.props.boundaries,
      { vh: s, scale: o } = T().state,
      n = (this.tl = i.timeline({ onUpdate: this.updateItems })),
      a = s,
      r = e + 300 * o,
      l = t - s,
      p = 0.5 * s;
    n.fromTo(
      this.tweens,
      { inPr: 0 },
      { inPr: 1, duration: a, ease: "power2.out" },
      r
    );
    const c = (Xt ? 100 : 200) * o;
    n.fromTo(
      [this.ui.arrowUp, this.ui.arrowDown],
      { alpha: 0 },
      { alpha: 1, duration: 1, ease: "power3.out" },
      r
    ),
      n.fromTo(
        this.ui.arrowUp,
        { y: -c },
        { y: 0, duration: a, ease: "power3.out" },
        r
      ),
      n.fromTo(
        this.ui.arrowDown,
      ...
      n.fromTo(
        this.tweens,
        { outPr: 0 },
        { outPr: 1, duration: p, ease: "power2.out" },
        l
      ),
      n.fromTo(
        this.tweens,
        { outRotPr: 0 },
        { outRotPr: 1, duration: p, ease: "power2.inOut" },
        l + 0.2 * p
      ),
      n.to(this.ui.arrowUp, { y: -c, duration: p, ease: "power2.inOut" }, l),
      n.to(this.ui.arrowDown, { y: c, duration: p, ease: "power2.inOut" }, l),
      n.to(
        [this.ui.arrowUp, this.ui.arrowDown],
        { alpha: 0, duration: 1 },
        l + 0.5 * p
      ...
      n.seek(0.001),
      this.options.tl && this.options.tl.add(n, 0.001);
  }
  onActive() {
    this.updateItems();
  }
  ...
  offLoopCards({ firstTrigger: e }) {
    var t;
    e || null == (t = this.loopDelay) || t.kill();
  }
  setIndex(e, { firstTrigger: t }) {
    if (t) return;
    this.sounds[ns(0, this.sounds.length - 1)].play();
    const { nextItemDuration: s } = this.props;
    i.killTweensOf(this.tweens, "indexPr"),
      i.to(this.tweens, {
        indexPr: e,
        ease: "expo.out",
        delay: 0.2,
  ...
  onDestroy() {
    var e, t;
    null == (e = this.tl) || e.kill(),
      null == (t = this.loopDelay) || t.kill(),
      i.killTweensOf(this.tweens);
  }
}
Dt(Ys, [
  ae,
  ts(ss, {
    expanded: !0,
    keysOptions: { time: { min: 0, max: 1400, step: 1 } },
...
class Ks extends te {
  constructor() {
    super(...arguments),
      t(this, "options", { template: Ws, dir: -1, items: [], tweens: null }),
      t(this, "props", { active: !1, index: 0, zIndex: 0 });
  }
  async onSetup() {
    (this.el = this.options.el),
  ...
  async setupItems() {
    this.items = await Promise.all(
      this.options.items.map((e, t) =>
        new qs().setup({ options: { appendTo: this.inner, index: t, ...e } })
      )
    );
  }
  updateIndex(e) {
  ...
  update() {
    const { dir: e, tweens: t } = this.options,
      { zIndex: s } = this.props,
      { totalItems: i } = this;
    T().state,
      this.items.forEach((o, n) => {
        ...
        Xt && (m = jt(p, 0, 1, 50, m, !0)),
          (a.style.opacity = u),
          (a.style.transform = `translate3d(${
            h * e
          }px, 0, ${m}px) rotateY(${d}deg)`);
      });
  }
  onDestroy() {
...
class qs extends te {
  constructor() {
    super(...arguments),
      ...
      t(this, "props", { active: !1 }),
      t(this, "bounds", { width: 1, height: 1 });
  }
  async onSetup() {
    const { color: e, src: t } = this.options;
    (this.el.style.backgroundImage = `url(${t})`),
      n(this.el, (e) => {
        const t = e[0],
          { width: s, height: i } = t.contentRect;
        this.bounds = { width: s, height: i };
      });
  }
  udpate() {
    index;
...
class Qs extends te {
  constructor() {
    super(...arguments),
      t(this, "options", { template: Zs, id: "collection-gallery" }),
      t(this, "props", { active: !1 });
  }
  onEnter() {
    var e;
  ...
  async onSetup() {
    ...
    (this.lines = this.el.querySelectorAll(".js-line")),
      ...
      (this.gallery = await new Ys().setup({
        options: { appendTo: this.ui.bottom, tl: this.options.tl },
        props: {
          active: () => this.props.enter,
          boundaries: () => ({ start: this.props.start, end: this.props.end }),
        },
      })),
      this.waitForFonts();
  }
  ...
  setupTimeline() {
    ...
    const e = [this.ui.topLeft, this.ui.topRight],
      { start: t, end: s } = this.props,
      { vh: o, scale: n } = T().state,
      a = (this.tl = i.timeline({ onUpdate: this.updateItems })),
      r = o,
      l = t + 300 * n,
      p = s - o,
      c = Xt ? 0 : 250 * n;
    a.set(e, { alpha: 0 }, 0),
      ...
      a.fromTo(
        this.gallery.el,
        { y: -100 * n },
        { y: 0, duration: r, ease: "power3.out" },
        l
      ),
      a.fromTo(e, { y: c }, { y: 0, duration: r, ease: "power3.out" }, l),
      a.fromTo(
        this.lines,
        { alpha: 0 },
        { alpha: 1, duration: 0.5 * o, ease: "sine.out" },
        l
      );
    const h = Xt ? -0.5 * o : -o;
    a.to(e, { y: Xt ? 0 : h, duration: r, ease: "power3.inOut" }, p),
      a.to(this.gallery.el, { y: h, duration: r, ease: "power3.inOut" }, p),
      a.to(this.lines, { alpha: 0, duration: 0.2 * o, ease: "power2.in" }, p),
      a.to(e, { alpha: Xt ? 0 : 1, duration: 0.2 * o, ease: "power2.in" }, p),
      a.seek(0.001),
      this.options.tl && this.options.tl.add(a, 0);
  }
  resize(e) {
...
class si {
  constructor(
    e,
    {
      ...
      wrapS: l = Ce,
      wrapT: p = Ce,
      renderOptions: c = { target: null },
    } = {}
  ) {
    (this.renderer = e),
      (this.shader = t),
      (this.scene = new ye()),
      (this.orthoCamera = new xe(s / -2, s / 2, i / 2, i / -2, 1e-5, 1e3)),
    ...
    (this.fbo = {
      ...
      this.shader &&
        ((this.mesh = new ue(new Te(1, 1), this.shader)),
        this.mesh.scale.set(s, i, 1),
        this.scene.add(this.mesh));
  }
  setSize(e, t) {
    this.fbo.read.setSize(e, t),
      this.fbo.write.setSize(e, t),
      (this.orthoCamera.left = -e / 2),
      (this.orthoCamera.right = e / 2),
      (this.orthoCamera.top = t / 2),
      (this.orthoCamera.bottom = -t / 2),
      this.orthoCamera.updateProjectionMatrix(),
      this.mesh && this.mesh.scale.set(e, t, 1);
  }
  get texture() {
...
class oi extends te {
  constructor() {
    super(...arguments),
      t(this, "options", {
        template: ({ options: e }) => re`<div class="tableauStory">
      <div
        data-ui="caption"
  ...
  async onSetup() {
    Xt && this.el.parentNode.insertBefore(this.ui.caption, this.el),
      await this.setupText();
  }
  async setupText() {
    var e;
    null == (e = this.splitText) || e.revert(),
      (this.splitText = new l(this.ui.text, {
        type: "lines",
        linesClass: "line",
      }));
  }
  setActive(e, { firstTrigger: t }) {
    t && ii.set(this.el, { alpha: 0 }),
      ii.killTweensOf(this.el),
      ii.to(this.el, { alpha: 0 | e, duration: 0.2, ease: "steps(2)" }),
      ii.to(this.ui.caption, { alpha: 0 | e, duration: 0.2, ease: "steps(2)" });
  }
  get lines() {
...
const ni = Xt
    ? []
    : [
        { id: "trc", slot: "right-top", obp: "right top" },
        { id: "brc", slot: "right-bottom", obp: "right bottom" },
        { id: "blc", slot: "left-bottom", obp: "left bottom" },
        { id: "crl", slot: "center", obp: "center right", fit: "cover" },
        { id: "crs", slot: "center", obp: "center right", fit: "contain" },
        { id: "cbl", slot: "center", obp: "center bottom", fit: "cover" },
        { id: "cbs", slot: "center", obp: "center bottom", fit: "contain" },
        { id: "cl", slot: "center", depth: 0, fit: "cover" },
        { id: "cs", slot: "center", depth: 0, fit: "contain" },
      ],
  ai = ({ props: e }) => re`<div
    class="layer"
    ?active=${e.active}
...
class ri extends te {
  constructor() {
    super(...arguments),
      t(this, "options", { template: ai, layer: Ot.UI }),
      t(this, "props", {
        w: 1,
        h: 1,
        iFlow: 0,
        ...
        sizeLayout: [0, 0],
        sMedia: Xt ? 1.2 : 0.5,
        sGraphics: (e) => 0.25 * Math.min(e.ratio[0], e.ratio[1]),
      }),
      t(this, "propsAnim", { alpha: 0, blink: 1 });
  }
  onBeforeSetup() {
    this.object = new fe();
  }
  onAfterSetup() {
    (this.object.name = this.options.name || this.constructor.name),
      this.options.addTo &&
        !this.options.preventAddTo &&
        this.options.addTo.add(this.object);
  }
  async onSetup() {
    await this.setupVideo(),
      await this.setupGraphics(),
      await this.setupMesh(),
      (this.propsAnim.kfPosition = this.props.kfPosition.slice()),
      (this.propsAnim.kfScale = this.props.kfScale.slice());
  }
  async setupGraphics() {
    const { size: e, hasFrame: t, dataTableau: s } = this.options,
      i = Xt ? 35 : t ? 100 : 75,
      o = Xt ? 400 : 600;
    (this.graphicCaption = await new li().setup({
      options: { appendTo: this.ui.graphics1 },
      props: { v: () => this.props.active, padding: i, text: null },
    })),
      (this.graphics = await Promise.all(
        ni.map(
          async (t) =>
            await new pi().setup({
              options: {
              ...
              props: {
                ...
                sCenter: (t) => [
                  ((e[0] * this.props.kfScale[0]) / (o * t.sGraphics)) *
                    this.props.ratio[0],
                  ((e[1] * this.props.kfScale[1]) / (o * t.sGraphics)) *
                    this.props.ratio[1],
                ],
                s: (e) =>
                  "center" == t.slot
                    ? "cover" == t.fit
                      ? Math.max(e.sCenter[0], e.sCenter[1])
                      : Math.min(e.sCenter[0], e.sCenter[1])
                    : 1,
                padding: i,
                paddingInner: 0,
              },
  ...
  async setupVideo() {
    const { size: e } = this.options,
      t = (this.video = document.createElement("video"));
    (t.playsInline = !0),
      (t.muted = !0),
      (t.loop = !0),
      t.appendChild(j('<source src="" type=\'video/mp4; codecs="hvc1"\' />')),
      t.appendChild(j('<source src="" type="video/webm" />')),
      this.ui.media.appendChild(t),
      (this.props.w = e[0]),
      (this.props.h = e[1]);
  }
  updateSource({ source: e, src: t, type: s, filename: i } = {}) {
    if ("video" == s) {
    ...
    const n = (this.props.sourceSize =
      "img" === s ? [e.image.width, e.image.height] : [800, 800]);
    (this.props.type = s),
      this.shader.uniforms.uAspect.value.set(n[0], n[1]),
      (this.shader.defines.HAS_TEXTURE = "img" === s),
      (this.shader.needsUpdate = !0),
      this.updateGraphics({ filename: i });
  }
  updateGraphics({ filename: e } = {}) {
    this.graphicCaption.props.text = e.split("-").join(" ");
  }
  async setupMesh() {
    const { layer: e, size: t, hasFrame: s } = this.options,
      i = (this.shader = new Le({
        vertexShader: Wt,
        ...
        uniforms: {
          ...
          uScale: { value: 1 },
          uAlpha: { value: 1 },
          uAspect: { value: new de() },
          uResolution: { value: new de() },
          uFramePush: { value: Xt ? 20 : 40 },
        },
        defines: { HAS_TEXTURE: !1, HAS_FRAME: s ?? !1 },
        transparent: !0,
      }));
  ...
  createTimeline() {
    const { keyframesPosition: e, keyframesScale: t } = this.options,
      s = (this.tl = i.timeline());
    return (
      e.forEach((e) =>
        s.to(
          this.propsAnim.kfPosition,
          {
            0: e[1][0],
            1: e[1][1],
            duration: 0.5,
            ...
            onUpdate: () => {
              ...
              (this.props.kfPosition[0] = e),
                (this.props.kfPosition[1] = t),
                (this.props.kfPosition[2] = s);
            },
          },
          e[0]
        )
        ...
        s.to(
          this.propsAnim.kfScale,
          {
            ...
            onUpdate: () => {
              ...
              (this.props.kfScale[0] = e),
                (this.props.kfScale[1] = t),
                (this.props.kfScale[2] = s);
            },
          },
          e[0]
        )
  ...
  offActive() {
    var e;
    null == (e = this.video) || e.pause(),
      this.video && (this.video.currentTime = 0);
  }
  animateIn() {
    let e = 0,
      t = 0;
    const { propsAnim: s } = this;
    i.fromTo(
      this.propsAnim,
      { blink: 0 },
      {
  ...
  setPAnchorPoint(e) {
    var t, s;
    const { size: o } = this.options;
    null == (t = this.mesh) ||
      t.position.set(0.5 * o[0] - e[0], 0.5 * -o[1] + e[1], 0),
      null == (s = this.cardFrame) ||
        s.object.position.set(0.5 * o[0] - e[0], 0.5 * -o[1] + e[1], 0),
      i.set(this.el, { transformOrigin: `${e[0]}px ${e[1]}px` });
  }
  whileActive() {
    this.update();
  }
  update() {
    ...
    const {
      ...
      { size: l } = this.options,
      { alpha: p } = this.propsAnim;
    (this.props.pX = t[0]),
      (this.props.pY = t[1]),
      (this.props.s = [n[0], n[1], 1]),
      (this.props.o = p),
      (this.object.position.x = s[0] * o[0]),
      (this.object.position.y = -s[1] * o[1]),
      this.object.scale.fromArray(this.props.s),
      this.shader &&
        (null == (e = this.shader) ||
          e.uniforms.uResolution.value.set(l[0] * n[0], l[1] * n[1]),
        (this.shader.uniforms.uAlpha.value = p));
    const c = [l[0] * n[0], l[1] * n[1]],
      h = [
        c[0] / l[0] == 0 ? 0 : 1 / (c[0] / l[0]),
        c[1] / l[1] == 0 ? 0 : 1 / (c[1] / l[1]),
      ];
    if ("video" == r) {
      const e = Math.min(c[0] / 256, c[1] / 256);
      i.set(this.ui.media, { scaleX: h[0] * e, scaleY: h[1] * e });
    }
...
class li extends te {
  constructor() {
    super(...arguments),
      t(this, "options", {
        template: () =>
          re`<div class="layer__graphicCaption type-caption2"></div>`,
      }),
      t(this, "props", { align: "left", w: 300, h: 300 });
  }
  async onSetup() {
    (this.text = await new D().setup({
      options: { appendTo: this.el, textClass: "layer__caption" },
      props: { v: () => this.props.active },
    })),
      this.update();
  }
  async setText(e) {
  ...
  setV(e) {
    var t, s;
    e
      ? null == (t = this.text) || t.show({ delay: 0.33, stagger: 0.01 })
      : null == (s = this.text) || s.hide();
  }
  update() {
    const { padding: e } = this.props;
...
class pi extends te {
  constructor() {
    super(...arguments),
      t(this, "options", {
        template: ({ props: e, options: t }) => re`<div
  ...
  async onSetup() {
    const { id: e, obp: t } = this.options;
    (this.props.prefix = e),
      this.ui.graphic.style.setProperty("--obj-position", t),
      this.update();
  }
  setPrefix(e) {
    const { baseSize: t } = this.options,
      { paddingInner: s } = this.props;
    switch (e) {
      case "cbs":
      case "cbl":
        i.set(this.el, { transformOrigin: "bottom center" });
        break;
      case "crs":
      case "crl":
        i.set(this.el, { transformOrigin: "right center" });
    }
    (this.props.w = 1 * (t - s)), (this.props.h = 1 * (t - s));
  }
  update() {
    const { size: e, slot: t } = this.options,
      {
        sParent: s,
        sGraphics: i,
        w: o,
    ...
    "right-bottom" == t
      ...
      : "center" == t
      ? "crl" == r || "crs" == r
        ? ((l *= 1), (p *= 0.5), (l -= a + o), (p -= 0.5 * n))
        : "cbl" == r || "cbs" == r
        ? ((l *= 0.5), (l -= 0.5 * o), (p -= a + n))
        : ((l *= 0.5), (p *= 0.5), (l -= 0.5 * o), (p -= 0.5 * n))
      : ((l *= 1), (l -= o + a), (p *= 0), (p += a)),
      (this.props.pX = l),
      (this.props.pY = p);
  }
...
class ci extends te {
  constructor() {
    super(...arguments),
      ...
      t(this, "propsAnim", { pRot: 0, pLength: 0, pGap: 0.05 * Math.PI });
  }
  async onSetup() {
    const { addTo: e } = this.options;
    (this.object = new fe()),
      e.add(this.object),
      (this.vPosDamped = new de()),
      (this.shapes = []),
      await this.createArrows(),
      await this.createCircles();
  }
  async createArrows() {
    const { layer: e } = this.options;
    (this.groupArrows = new pe()), this.object.add(this.groupArrows);
    const t = { s: () => this.props.w };
    (this.aL = await new di().setup({
      options: { addTo: this.groupArrows, layer: e, side: 1 },
      props: t,
    })),
      (this.aR = await new di().setup({
        options: { addTo: this.groupArrows, layer: e },
        props: t,
      })),
  ...
  async createCircles() {
    ...
    const t = { addTo: this.groupCircle, layer: e },
      s = { s: () => this.props.w };
    (this.cL = await new hi().setup({ options: t, props: s })),
      (this.cR = await new hi().setup({ options: t, props: s })),
      (this.cC = await new hi().setup({
        options: t,
        props: { draw: () => this.props.draw, alpha: 0, ...s },
      })),
      this.shapes.push(this.cL, this.cR, this.cC);
  }
  getAnimation({ type: e = "active", bool: t } = {}) {
    const { propsAnim: s } = this,
      o = i.timeline({
    ...
    switch (e) {
        ...
        t
          ? o
              .fromTo(
                s,
                { pLength: 0 },
                { pLength: 1, duration: 1, ease: "power3.out" },
                0.1
              )
              .fromTo(
                s,
                { pRot: Math.PI },
                { pRot: 0, duration: 1.2, ease: "power2.out" },
                0
              )
              .fromTo(
                [this.aL.propsAnim, this.aR.propsAnim],
                { offset: 0.4, alpha: 0 },
                { offset: 0.36, alpha: 0.4, duration: 0.6, ease: "power3.out" },
                0.54
              )
              .fromTo(
                this.ui.icon,
                { scale: 0.8, alpha: 0 },
                { scale: 1, alpha: 1, duration: 0.6, ease: "power3.out" },
                0.54
              )
              .set(
                [this.cL.propsAnim, this.cR.propsAnim],
                { radius: 1, alpha: 0.4 },
                0
              )
              .to(this.ui.label0, { alpha: 1, duration: 0.5 }, 0.5)
          : o
              .to(
                this.shapes.map((e) => e.propsAnim),
                { alpha: 0, duration: 0.4, ease: "power2.out" },
                0
              )
              .to(
                [this.cL.propsAnim, this.cR.propsAnim],
                { radius: 0.88, duration: 0.4, ease: "power2.out" },
                0
              )
              .to(
                [this.ui.label0, this.ui.label1],
      ...
      case "hold":
        o.to(
          ...
          .to(
            this.cC.propsAnim,
            { radius: t ? 0.82 : 1, duration: 0.4, ease: "power2.out" },
            0
          )
          .to(s, { pGap: 0 | t, duration: 0.2, ease: "power2.out" }, 0)
          .to(
            this.ui.icon,
            {
              alpha: 0 | !t,
          ...
          .to(
            this.ui.label0,
            { alpha: 0 | !t, duration: 0.2, ease: "sine.out" },
            0
          )
          .to(
            this.ui.label1,
  ...
  setActive(e, { firstTrigger: t }) {}
  setCanShow(e, { firstTrigger: t }) {
    var s, o;
    t &&
      (i.set([this.ui.label0, this.ui.label1, this.ui.icon], { alpha: 0 }),
      i.set(
        this.shapes.map((e) => e.propsAnim),
        { alpha: 0 }
      )),
      null == (s = this.tlHold) || s.kill(),
      null == (o = this.tlActive) || o.kill(),
      (this.tlActive = this.getAnimation({ type: "active", bool: e })),
      this.update();
  }
  setHold(e, { firstTrigger: t }) {
    var s, i;
    t ||
      (null == (s = this.tlActive) || s.kill(),
      null == (i = this.tlHold) || i.kill(),
      (this.tlHold = this.getAnimation({ type: "hold", bool: e })));
  }
  whileVisible() {
    this.update();
  }
  update() {
    const { pRot: e, pLength: t, pGap: s } = this.propsAnim,
      { delta: o } = It.getInstance(),
      n = zt(0.1 * Math.PI, 0, s);
    (this.groupCircle.rotation.z = e),
      (this.cL.props.offset = 1.5 * Math.PI + n),
      (this.cR.props.offset = 0.5 * Math.PI + n),
      (this.cC.props.offset = 0.5 * Math.PI);
    const a = Math.PI - 2 * n;
    (this.cL.props.length = this.cR.props.length = zt(0, a, t)),
      i.set(this.ui.label0, {
        x: this.vPosDamped.x - this.props.pX,
        y: this.vPosDamped.y - this.props.pY,
      }),
      (this.vPosDamped.x = $t(this.vPosDamped.x, this.props.pX, o, 16)),
      (this.vPosDamped.y = $t(this.vPosDamped.y, this.props.pY, o, 16)),
      this.object.position.set(this.vPosDamped.x, -this.vPosDamped.y, 0);
...
class hi extends te {
  constructor() {
    super(...arguments),
      t(this, "options", {}),
      t(this, "props", { s: 100, draw: 0, offset: 0, length: 2 * Math.PI }),
      t(this, "propsAnim", { alpha: 0.7, radius: 1 });
  }
  async onSetup() {
    const { layer: e } = this.options,
      t = new Le({
  ...
  update() {
    const { offset: e, length: t, draw: s } = this.props,
      { propsAnim: i } = this;
    (this.mesh.material.uOffset = e),
      (this.mesh.material.uLength = t),
      (this.mesh.material.uRadius = i.radius),
      (this.mesh.material.uAlpha = i.alpha),
      (this.mesh.material.uDraw = zt(0, 2 * Math.PI, s));
  }
}
Dt(hi, [Et]);
class di extends te {
  constructor() {
    super(...arguments),
      ...
      t(this, "options", {}),
      t(this, "props", { s: 100 }),
      t(this, "propsAnim", { offset: 1, alpha: 0 });
  }
  async onSetup() {
    const { layer: e, side: t } = this.options,
      s = new Le({
        vertexShader: Wt,
  ...
  update() {
    const { propsAnim: e } = this;
    (this.mesh.material.uOffset = e.offset),
      (this.mesh.material.uAlpha = e.alpha);
  }
}
Dt(di, [Et]);
const ui = ({ options: e }) => re`<div
...
class mi extends te {
        ...
        <div class="sdLayerShell__blocks">
          ${
            Xt
              ...
              : re`<div
                  class="block"
                  style="--blockPaddingExtra: ${
                    e.sInner * t.data.titleFontSize
                  }px"
                >
                  ${
                    "factions" == t.data.id
                      ? ui({ props: e, options: t })
                      : null
                  }
                  ${
                    "keep" == t.data.id
                      ? re`<hr class="lineBase line--right"></hr>`
                      : null
                  }
                </div>
                <div class="block">
                  ${
                    "keep" == t.data.id || "universe" == t.data.id
                      ? ui({ props: e, options: t })
                      : null
                  }
                </div>`
  ...
  setActive(e, { firstTrigger: t }) {
    t && i.set(this.ui.detail, { alpha: 0, x: 10 }),
      i.to(this.ui.detail, {
        alpha: 0 | e,
        x: e ? 0 : 10,
        delay: 0.2,
...
class fi extends te {
  constructor() {
    super(...arguments),
      ...
      t(this, "props", { sInner: 1, fontSize: 150 }),
      t(this, "onUpdate", () => {
        const e = performance.now(),
          t = [...this.split0.chars, ...this.split1.chars];
        if (
          ((this.tElapsed += e - this.tLast),
          (this.tLast = e),
          this.tElapsed > 60)
        ) {
          this.tElapsed = 0;
          for (let e = 0; e < t.length; e++) {
            const s = t[e];
            i.set(s, { alpha: Math.random() > 0.5 ? 1 : 0 });
          }
        }
      }),
      t(this, "onComplete", (e) => {
  ...
  async onSetup() {
    (this.tElapsed = 0),
      (this.tLast = 0),
      (this.split0 = new l(this.ui.title0, { type: "chars" })),
      (this.split1 = new l(this.ui.title1, { type: "chars" })),
  ...
  setActive(e, { firstTrigger: t }) {
    ...
    t && i.set([...s, this.ui.caption], { alpha: 0 }),
      i.killTweensOf(s),
      e
        ? (i.fromTo(
            s,
        ...
        : i.set([...s, this.ui.caption], { alpha: 0 });
  }
  setSInner(e) {
    this.el.style.setProperty("--sInner", e),
      i.set(this.ui.outer, { scale: e });
  }
}
Dt(fi, [ae]);
const vi = [
      ...
      layersData: [
        {
          ...
          options: {
            iSet: 0,
            assets: [
              "inside-kai-fusion-reactor#img",
              "keep-mountain-area#img",
              "mountain-topology-B#video",
            ],
          },
        },
        {
          ...
          options: {
            iSet: 1,
            assets: [
              "main-tower-scan#video",
              "keep-wireframe-scan#video",
              "protection-tower-scan#video",
            ],
            hasFrame: !0,
          },
        },
        {
          ...
          options: {
            iSet: 2,
            assets: [
              "mining-area-scan#video",
              "mining-area-scan#video",
              "kai-fusion-reactor#img",
            ],
          },
        },
        {
          ...
          options: {
            iSet: 3,
            assets: [
              "mountain-topology-A#video",
              "kpco-mining-machinery#video",
              "keep-tower-structure#video",
            ],
            hasFrame: !0,
          },
        },
      ...
      layersData: [
        {
          ...
          options: {
            ...
            assets: [
              "animus-logo#video",
              "prisma-logo#video",
              "animus-attributes#img",
              "prisma-attributes#img",
            ],
          },
        },
        {
          ...
          options: {
            iSet: 1,
            assets: [
              "animus-character-scan#video",
              "prisma-character-scan#video",
              "active-crystal-reaction#video",
              "prisma-hand-tech-scan#video",
            ],
            hasFrame: !0,
          },
        },
        ...
        },
        {
          ...
          options: {
            iSet: 3,
            assets: [
              "elixir-1-component#video",
              "silicon-6-sword#video",
              "elixir-2-component#video",
              "carbon-fiber-bow#video",
            ],
            hasFrame: !0,
          },
        },
        ...
        },
        {
          ...
          options: {
            iSet: 5,
            assets: [
              "blood-star-bow#video",
              "grade-4-titanium-sword#video",
              "white-crystal-sword#video",
              "reinforced-mercurian-sword#video",
            ],
            hasFrame: !0,
          },
        },
      ...
      layersData: [
        {
          ...
          options: {
            ...
            assets: [
              "boon-noodles#video",
              "neon-salmon-dish#img",
              "klmx-portable-transmeter#video",
            ],
            hasFrame: !0,
          },
        },
        {
          ...
          options: {
            iSet: 1,
            assets: [
              "boon-food-station#img",
              "neon-review#img",
              "encrypted-audio-signal#video",
            ],
            hasFrame: !0,
          },
        },
        ...
        },
        {
          ...
          options: {
            iSet: 4,
            assets: [
              "boon-transmission#img",
              "neon-transmission#img",
              "klmx-transmission#img",
            ],
            hasFrame: !0,
          },
        },
...
class wi extends te {
  ...
  setActive(e, { firstTrigger: t }) {
    ...
    t && ii.set(this.el, { alpha: 0 }),
      ...
      (this.tlActive = ii
        ...
        .to(this.el, { alpha: 0 | e, duration: 0.3, ease: "power3.out" })
        .fromTo(
          this.ui.arrowL,
          { x: e ? 5 : 0 },
          { x: e ? 0 : -5, duration: 0.3, ease: "power2.out" },
          0.1
        )
        .fromTo(
          this.ui.arrowR,
  ...
  setHold(e) {
    ii.set(this.ui.labelWrap, { alpha: e ? 0 : 0.5 }),
      ii.set(this.ui.progressWrap, { alpha: e ? 1 : 0 });
  }
  setDraw(e) {
    ii.set(this.ui.progress, { scaleX: e, transformOrigin: "0 50%" });
  }
}
Dt(wi, [ae]);
const yi = [
...
`,
  xi = class extends te {
    constructor() {
      super(...arguments),
        ...
        t(this, "props", {
          ...
          active: !1,
          viewport: () => [
            T().state.viewport.width,
            T().state.viewport.height100vh,
          ],
          bounds: (e) => ({ x: 0, y: 0, w: e.viewport[0], h: e.viewport[1] }),
          sizeComp: Xt ? [375, 630] : [1920, 1080],
          sizeNorm: (e) => [
            e.viewport[0] / e.sizeComp[0],
            e.viewport[1] / e.sizeComp[1],
          ],
          tSequence: 0,
          play: !1,
          progress: 0,
    ...
    async onSetup() {
      const { scene: e, debug: t } = this.options;
      (this.wrapper = new pe()),
        e.add(this.wrapper),
        (this.assets.aeData = await g("/data/2ndlayer.ae.json").load()),
        (this.pointer = s()),
    ...
    async setupLayers() {
      const { aeData: e } = this.assets,
        { tableau: t } = this.options,
        s = Xt ? `${t}Mobile0` : `${t}0`,
        i = (this.composition = e.project.compositions.find(
          (e) => e.name === s
        ));
      this.layers = await Promise.all(
        i.layers.map(async (e, t) => await this.createLayer(e, t))
      );
    }
    async createLayer(e, t) {
      const { debug: s } = this.options,
        { name: i, properties: o, inOut: n, size: a } = e,
        r = this.options.data.layersData.find((e) => e.name === i),
        l = {
      ...
      return await new ri().setup({
        ...
        props: {
          active: () =>
            this.props.active &&
            (s || this.props.play) &&
            fs(this.props.tSequence, n[0], n[1]),
          v: (e) => e.active,
          iSet: l.iSet,
          iFlow: () => this.props.iFlow,
          ...
          posLayoutOffset: (e) => [
            -e.kfAnchor[0] * (1 / e.ratio[0]),
            -e.kfAnchor[1] * (1 / e.ratio[1]),
          ],
          posLayout: (e) => [
            (e.posLayoutOffset[0] + e.kfPosition[0]) * this.props.sizeNorm[0],
            (e.posLayoutOffset[1] + e.kfPosition[1]) * this.props.sizeNorm[1],
          ],
          sizeLayout: (e) => [
            e.ratio[0] * e.kfScale[0],
            e.ratio[1] * e.kfScale[1],
          ],
    ...
    async setupUI() {
      const { scene: e, data: t } = this.options;
      (this.btnHold = await (Xt ? new wi() : new ci()).setup({
        options: { appendTo: xi.wrapperComp.el, addTo: e, preventAddTo: !1 },
        props: {
          active: () => this.props.active,
        ...
        (this.shell = await new mi().setup({
          options: { appendTo: this.el, data: t },
          props: {
    ...
    stop() {
      this.props.active &&
        ((this.props.play = !1), this.soundIn.stop(), this.soundOut.play());
    }
    async setPlay(e, { firstTrigger: t }) {
      var s, i, o;
      if (t) return;
      T().state.secondLayerActive = e;
      const n = this.options.data.layersNumFlows;
      e
        ? (null == (s = this.tlSequence) || s.play(),
          this.options.onPlay && this.options.onPlay(!0))
        : (null == (i = this.tlSequence) || i.restart(),
          null == (o = this.tlSequence) || o.pause(),
          (this.props.iFlow = (this.props.iFlow + 1) % n),
          (this.props.tSequence = 0),
          this.options.onPlay && this.options.onPlay(!1),
          (this.btnHold.props.draw = 0),
          this.updateLayers());
    }
    setActive(e) {
    ...
    async updateLayers() {
      const { tableau: e } = this.options,
        { iFlow: t } = this.props;
      this.layers.forEach(async (s) => {
        const { assets: i, iSet: o } = s.options,
          n = i[t],
          { type: a, filename: r } = ((e) => {
            const t = e.split("#"),
              s = t[0],
            ...
            return { url: s, types: i, type: o, filename: n, basename: a };
          })(n),
          l = yi.find((e) => n.includes(e)),
          p = !l,
          c = `${
            "img" === a
              ? `/images/${
                  l ? "" : "compressed/ktx/"
                }tableau/${e}/second-layer/flow-${t}/set-${o}`
              : `/images/tableau/${e}/second-layer/flow-${t}/set-${o}`
          }/${r}${"video" === a ? "" : l ? ".png" : p ? ".ktx2" : ".webp"}`;
        if ("img" === a) {
          (p ? w : y)(c)
            .load()
            .then((e) => {
              s.updateSource({ src: c, source: e, type: a, filename: r });
            })
            .catch((e) => {});
        } else s.updateSource({ src: c, source: null, type: a, filename: r });
      }),
        (this.props.firstUpdate = !1);
    }
    resize() {}
    setViewport([e, t]) {
      this.wrapper.position.set(0.5 * -e, 0.5 * t, 0);
    }
    whileActive() {
      const [e, t] = this.props.viewport,
        { x: s, y: i } = this.pointer;
      if (
        (Xt ||
          ((this.btnHold.props.pX = s.value - 0.5 * e),
          (this.btnHold.props.pY = i.value - 0.5 * t)),
        this.options.hasRendering)
      ) {
        const { renderer: e } = It.getInstance();
        e.clear(), this.render();
      }
    }
    render() {
      const { renderer: e, orthoCamera: t } = It.getInstance(),
        { scene: s } = this.options;
      e.clearDepth(), t.layers.set(Ot.UI), e.render(s, t);
    }
    onDestroy() {
      this.layers.forEach((e) => e.destroy()),
        (this.layers = null),
        xi.wrapperComp && (xi.wrapperComp.destroy(), (xi.wrapperComp = null));
    }
  };
let Si = xi;
t(Si, "wrapper"),
  Dt(Si, [
    ...
    ts(ss, {
      ...
      keysOptions: { progress: { min: 0, max: 1, step: 0.01 } },
    }),
  ]);
class Ti extends te {
  constructor() {
...
const Ai = {
    options: {
      ...
      soundId: "1_thekeep",
      posInit: [0, 0, 0],
      distOrbitDefault: 0.002 * Math.PI,
      distOrbitHold: 0.001 * Math.PI,
      useMask: !0,
      usePass: !0,
    ...
    async onSetup() {
      ...
      const { useHelpers: e, usePass: t } = this.options;
      (this.vLookAt = new Pe()),
        (this.vCamWrap0 = new Pe()),
        (this.vCamWrap1 = new Pe()),
        (this.tLast = 0),
        (this.tElapsed = 0),
        (this.pointer = s());
      ...
      await this.setupScene(),
        Xt || (await this.setupSceneBG()),
        await this.setupCamera(),
        t && (await this.setupPass()),
        e && this.addHelpers(),
        await this.setupCards(),
        await this.setupSecondLayer(),
        await this.setupStoryBlock();
    },
    async setupScene() {
      const { objects: e, assets: t } = this,
        { maxLayers: s } = this.options,
        i = [],
        o = (this.scene = new ye()),
        n = this.assets.gltf,
        a = (this.gltfScene = n.scene);
      a.traverse((n) => {
        if (n.isMesh && n.material) {
          const { name: a } = n.userData,
            r = e.find((e) => e.id === a),
            l = new ((r && r.class) || $)().setup({
              options: {
                addTo: o,
                gltfRef: n,
                preventAddTo: !0,
                maxLayers: s,
                assets: t,
                data: (null == r ? void 0 : r.options.spritesheets)
                  ? Array.from(new Array(r.options.spritesheets.amount)).map(
                      (e, s) => ({
        ...
        this.scene.add(a),
        (this.sceneObjects = await Promise.all(i));
      const r = a.getObjectByName("camera_target");
      r && (this.vLookAt = new Pe().copy(r.position));
    },
    async setupSceneBG() {
      const { cBackground: e } = this.options,
        t = new Le({
          vertexShader: Wt,
          fragmentShader:
            "\n        uniform vec3 uColor;\n        void main() {\n          vec3 c = uColor;\n          gl_FragColor = vec4(c, 1.);    \n        }",
          transparent: !0,
          uniforms: { uColor: { value: new Me(e) } },
        }),
    ...
    async setupCards() {},
    async setupCamera() {
      const { useControls: e, distOrbitDefault: t, posInit: s } = this.options;
      (this.cameraSystem = await new rs().setup({
        options: { vInit: new Pe().fromArray(s), vTarget: this.vLookAt },
        props: {
        ...
        e
          ? ((this.camera = It.getInstance().perspCamera),
            (this.el.style.pointerEvents = "none"))
          : ((this.camera = this.cameraSystem.camera),
            (this.cameraWrapper = new fe()),
            this.cameraWrapper.add(this.camera),
            this.scene.add(this.cameraWrapper));
    },
    async setupSecondLayer() {
      const { id: e, soundId: t, data: s } = this.options;
      this.secondLayer = await new Si().setup({
        ...
        props: { active: () => this.props.activeLayer },
      });
    },
    async setupStoryBlock() {
      const { data: e, copy: t } = this.options;
      this.storyBlock = await new oi().setup({
        ...
        props: {
          active: () =>
            this.props.active &&
            (!this.secondLayer || !this.secondLayer.props.play),
        },
      });
    },
    async setupPass() {
      ...
      const s = (this.shaderPass = new Le({
        ...
        uniforms: {
          ...
          uExposure: { value: 0 },
          uPurpleRot: { value: 0 },
          uPurpleAmount: { value: 0 },
          uFlickResolution: { value: new de(128, 1) },
          uFlickProgress: { value: 0 },
      ...
      qt(s), (this.pass = new si(It.getRenderer(), { shader: s }));
      for (const i in this.pass.fbo) this.pass.fbo[i].stencilBuffer = !0;
      s.uniforms.tMap.value = this.pass.fbo.write.texture;
    },
    getAnimHold(e) {
      const { zoom0Tg: t, zoom1Tg: s } = this.options,
        { propsAnim: o } = this,
        n = i.timeline({}).call(() => this.onShellCall(e), 0);
      return (
        e
          ? n
              .fromTo(
                o,
                { flick: 0 },
                { duration: 2, flick: 1, ease: "none" },
                0
              )
              .to(o, { exposure: 1, duration: 0.5, ease: "power3.out" }, 0)
              .to(o, { zoom0: t || 1, duration: 0.5, ease: "expo.out" }, 0)
              .to(o, { zoom1: s || 1, duration: 8, ease: "sine.out" }, 0)
          : n
              .set(o, { flick: 0 }, 0)
              .to(o, { exposure: 0, duration: 1, ease: "power3.out" }, 0)
              .to(o, { zoom0: 0, duration: 0.8, ease: "power3.out" }, 0)
              .to(o, { zoom1: 0, duration: 0.8, ease: "power3.out" }, 0),
        n
      );
    },
    getAnimStory() {
      const { scale: e, vh: t } = T().state,
        s = Xt ? 0.8 : 1,
        o = 500 * e * s,
        n = 30 * e * s,
        a = 30 * e * s,
        r = this.props.end - this.props.start,
        l = [this.storyBlock.ui.caption, ...this.storyBlock.lines],
        { startAnimStory0: p } = this.propsAnim;
      return i
        .timeline({ paused: !0 })
        .fromTo(
          l,
          { y: n, alpha: 0 },
          { y: 0, alpha: 1, duration: o, ease: "expo.out", stagger: a },
          p || 1.2 * t
        )
        .to(
          l,
          { y: -n, alpha: 0, duration: 0.5 * o, ease: "power2.in", stagger: a },
          r - 1.8 * t
        );
    },
    onPointerIn(e) {
      ...
      e.preventDefault(),
        Xt
          ? (this.toCallback = setTimeout(() => {
              var e;
              null == (e = this.secondLayer) || e.play();
            }, 50))
          : null == (t = this.secondLayer) || t.play();
    },
    onPointerOut(e) {
      var t;
      e.preventDefault(),
        this.toCallback && clearTimeout(this.toCallback),
        null == (t = this.secondLayer) || t.stop();
    },
    onShellCall(e) {
      T().state.hideShell = e;
    },
    onSecondLayerAction(e) {
      var t;
      const { distOrbitDefault: s, distOrbitHold: i } = this.options;
      (this.cameraSystem.props.distOrbit = e ? i : s),
        null == (t = this.tlHold) || t.kill(),
        (this.tlHold = this.getAnimHold(e)),
        (this.props.play = e);
    },
    setActiveLayer(e) {
      var t;
    ...
    updateCard() {
      const { rCard: e } = this.propsAnim,
        { delta: t } = It.getInstance(),
        { width: s, height: i } = this.props.viewport,
        { x: o, y: n } = this.pointer;
      ...
      const a = 0.25,
        ...
        p = 1 * jt(l, 0, i, -a, a),
        c = 1 * jt(r, 0, s, -a, a);
      (e[0] = me.damp(e[0], p, 3, t)),
        (e[1] = me.damp(e[1], c, 3, t)),
        (this.card.props.rMotion[0] = e[0]),
        (this.card.props.rMotion[1] = e[1]);
    },
    updatePass(e) {
      const { ppRot: t, ppAmount: s, exposure: i, flick: o } = this.propsAnim;
      (this.shaderPass.uTime = e % 10),
        (this.shaderPass.uExposure = i),
        (this.shaderPass.uFlickProgress = o),
        (this.shaderPass.uPurpleRot = t),
        (this.shaderPass.uPurpleAmount = s);
    },
    resize({ width: e, height: t, height100vh: s }) {
      var i, o, n;
      const { id: a } = this.options;
      "keep" == a && (this.propsAnim.startAnimStory0 = 1.1 * t),
        null == (i = this.tlStory) || i.kill(),
        (this.tlStory = null),
        (this.tlStory = this.getAnimStory()),
        null == (o = this.shaderPass) || o.uResolution.set(e, t),
        null == (n = this.meshBG) || n.scale.set(e, s, 1);
    },
    onPostResize() {
      var e, t, s;
      const { perspCamera: i, renderer: o } = It.getInstance(),
        [n, a] = Nt(0, i),
        { width: r, height: l } = this.props.viewport,
        { height: p } = this.props.bounds,
        c = o.getPixelRatio();
      (this.props.screenUnit = l / p),
        (this.card.props.s = [n * (Xt ? 1.8 : 1.1), a * (Xt ? 1.15 : 1.25), 1]),
        null == (e = this.pass) || e.setSize(r * c, l * c),
        null == (t = this.st) || t.refresh(),
        null == (s = this.secondLayer) || s.resize();
    },
    setZoom(e) {
      const { useControls: t } = this.props;
      t || ((this.camera.zoom = e), this.camera.updateProjectionMatrix());
    },
    onDestroy() {
      this.sceneObjects.forEach((e) => e.destroy()),
        ...
        this.scene.traverse((e) => {
          ...
          null ==
            (o =
              null ==
              (i =
                null == (s = null == (t = e.material) ? void 0 : t.uniforms)
                  ? void 0
                  : s.uTexture)
                ? void 0
                : i.value) || o.dispose(),
            null ==
              (l =
                null ==
                (r =
                  null == (a = null == (n = e.material) ? void 0 : n.uniforms)
                    ? void 0
                    : a.tMap)
                  ? void 0
                  : r.value) || l.dispose(),
            null == (p = e.material) || p.dispose(),
            null == (c = e.geometry) || c.dispose();
        });
          ...
          null ==
            (o =
              ...
              (i =
                ...
                ? void 0
                : i.value) || o.dispose(),
            null == (n = e.material) || n.dispose(),
            null == (a = e.geometry) || a.dispose();
        });
...
class ki extends te {
  constructor() {
    super(...arguments),
      t(this, "options", { layer: Ot.MAIN }),
      t(this, "props", { enter: !1 });
  }
  async onSetup() {
    const { gltfRef: e, layer: t, maxLayers: s } = this.options,
      i = (this.mesh = e),
      { order: o } = i.userData,
      n = H.instance.assets.mapPNoise;
    ...
    const r = new Le({
      ...
      uniforms: {
        tMap: { value: a },
        tNoise: { value: n },
        uResolution: { value: new de(1024, 1024) },
        uTime: { value: 0 },
      },
      transparent: !0,
      type: "BeamMaterial",
    ...
    qt(r),
      X(i, { w: a.source.data.width, h: a.source.data.height }),
      (i.material = r),
      (i.matrixAutoUpdate = !1),
      i.layers.set(t),
      i.updateMatrix(),
      o &&
        ((i.material.depthWrite = i.material.depthTest = !1),
        (i.renderOrder = s - o));
  }
  whileEnter(e) {
...
class Ci extends te {
  ...
  async onSetup() {
    const { gltfRef: e, layer: t, maxLayers: s, assets: i } = this.options,
      o = (this.mesh = e),
      { order: n } = o.userData,
      a = o.material.map;
    a && (a.encoding = Fe);
    ...
    qt(r),
      ...
      o.updateMatrix(),
      n &&
        ((o.material.depthWrite = o.material.depthTest = !1),
        (o.renderOrder = s - n));
  }
  whileEnter(e) {
    this.mesh.material.uTime = 0.01 * e;
  }
}
Dt(Ci, [Et]);
const Li = ".ktx2",
  Pi = class extends te {
    ...
    >
      ...
      ></div>
        ...
        t(this, "props", {
          active: (e) => e.enter && e.time > 0.46 * T().state.vh,
          mode: (e) =>
            e.progress < e.screenUnit && !Xt
              ? Pi.MODES.INTRO
              : Pi.MODES.DEFAULT,
          zoomStart: Xt ? -0.4 : -0.1,
            ...
            : [
                {
                  ...
                  options: {
                    fps: 60,
                    spritesheets: { id: "sheetCharacter", amount: 3 },
                    sequences: [{ id: "default", from: 0, to: 120, loop: -1 }],
                  },
                },
                {
                  id: "ship_fx",
                  ...
                  options: {
                    fps: 30,
                    spritesheets: { id: "sheetBeamShip", amount: 3 },
                    sequences: [{ id: "default", from: 0, to: 59, loop: -1 }],
                  },
                },
                {
                  id: "beams_fx",
                  ...
                  options: {
                    fps: 15,
                    spritesheets: { id: "sheetKai", amount: 4 },
                    sequences: [{ id: "default", from: 0, to: 67, loop: -1 }],
                  },
                },
                { id: "lower_beam_fx", class: ki, options: {} },
              ]),
          { id: "rays_fx", class: Ci, options: { preventAddTo: !1 } },
        ]),
        t(this, "assets", {
          gltf: `${V.gltfBaseFolder}tableaux-keep/tableaux-keep-${
            Xt ? "mobile" : V.textureSize
          }${V.hasMobileFallback ? "-fallback" : ""}.glb`,
          ...(V.hasMobileFallback
            ? {}
            : {
                sheetCharacter0:
                  "/images/tableau/keep/character-light/character-light-0.json#json",
                sheetCharacter1:
                  "/images/tableau/keep/character-light/character-light-1.json#json",
                sheetCharacter2:
                  "/images/tableau/keep/character-light/character-light-2.json#json",
                ...
                sheetBeamShip0:
                  "/images/tableau/keep/beam-ship/beam-ship-0.json#json",
                sheetBeamShip1:
                  "/images/tableau/keep/beam-ship/beam-ship-1.json#json",
                sheetBeamShip2:
                  "/images/tableau/keep/beam-ship/beam-ship-2.json#json",
    ...
    async onAfterSetup() {
      this.options.useControls && (this.camera.position.z = 2),
        (this.tlIn = this.getAnimIn());
    }
    async setupCards() {
      const e = 0.1 * Math.PI,
        t = 0.04 * Math.PI;
      this.card = await new gs().setup({
        options: { addTo: this.scene, idPath: Xt ? "mask-mobile" : "mask1" },
        props: {
          viewport: this.props.viewport,
          pr: () => this.props.progress,
          v: (e) => this.props.active && e.pr > this.props.screenUnit,
          pOut: () => this.props.pOut,
          pMotion: (e) => jt(e.pOut, 0, 0.25, 0, 1, !0),
      ...
      this.cardsTableau = await Promise.all(
        s.map(
          async (e, t) =>
            await new Ri().setup({
              options: {
              ...
              props: {
                ...
                pIn1: (e) =>
                  jt(
                    e.pr,
                    0.5 * this.props.screenUnit,
                    this.props.screenUnit,
                    0,
                    1,
                    !0
                  ),
    ...
    getAnimIn() {
      const e = i.timeline({ paused: !0 });
      return (
        Xt ||
          e.fromTo(
            this.vCamWrap1,
            { x: -0.08, z: 0.2 },
            { x: 0, z: 0, duration: 2, ease: "sine.out" },
            0
          ),
        this.cardsTableau.map((t, s) => e.add(t.getAnimIn(), 0.08 * s)),
        e
      );
    }
    whileEnter() {
      var e, t;
      const { zoom0: s, zoom1: i } = this.propsAnim,
        { progress: o, screenUnit: n, zoomStart: a } = this.props,
        r =
          a +
          (Xt
            ? 1
            : jt(o, 0.4 * n, n, 0.9, 1, !0) + es(s, 0, -0.1) + es(i, 0, -0.2));
      this.props.zoom !== r && (this.props.zoom = r),
        null == (e = this.cameraWrapper) ||
          e.position.copy(this.vCamWrap0).add(this.vCamWrap1),
        null == (t = this.meshRef) || t.position.copy(this.vLookAt);
    }
    setProgress(e) {
      const { screenUnit: t, progress: s } = this.props,
        i = jt(s, 1 - t, 1, 0, 1, !0);
      (this.propsAnim.ppRot = es(i, 0, 0.5 * Math.PI)),
        (this.propsAnim.ppAmount = es(i, 0, 1)),
        (this.vCamWrap0.y = es(e, Xt ? 0.06 : 0.08, Xt ? -0.04 : -0.06));
    }
    setTime(e) {
      var t, s;
      const i = 0.46 * (T().state.vh ? T().state.vh : 0),
        o = 1.2 * (T().state.vh ? T().state.vh : 0),
        n = jt(e, i, o, 0, 1, !0);
      null == (t = this.tlIn) || t.progress(n),
        null == (s = this.tlStory) || s.seek(e);
    }
    render() {
      var e, t, s, i;
      const { renderer: o, perspCamera: n, orthoCamera: a } = It.getInstance(),
        { useMask: r } = this.options;
      r
        ? this.props.mode === Pi.MODES.DEFAULT
          ? ((this.props.play && Xt) ||
              (this.pass && (o.setRenderTarget(this.pass.fbo.write), o.clear()),
              o.clearDepth(),
              o.clearStencil(),
              bs({
                renderer: o,
              ...
              xs({ renderer: o, layer: Ot.BG, camera: a, scene: this.scene }),
              xs({
                renderer: o,
                layer: Ot.MAIN,
                camera: this.camera,
            ...
            null == (e = this.pass) || e.render(!0, { clear: !0 }))
          : (this.pass && (o.setRenderTarget(this.pass.fbo.write), o.clear()),
            a.layers.set(Ot.BG),
            o.render(this.scene, a),
            this.camera.layers.set(Ot.MAIN),
            o.render(this.scene, this.camera),
            o.setRenderTarget(null),
            null == (t = this.pass) || t.render(!1, { clear: !0 }))
        : (this.pass && o.setRenderTarget(this.pass.fbo.write),
          o.clear(),
          n.layers.set(Ot.MAIN),
          o.render(this.scene, this.camera),
          o.setRenderTarget(null),
          null == (s = this.pass) || s.render(!0)),
        null == (i = this.secondLayer) || i.render();
    }
    onBeforeDestroy() {
...
let Mi = Pi;
t(Mi, "MODES", { INTRO: "mode:intro", DEFAULT: "mode:default" }),
  Dt(Mi, [
    Ai,
    E,
    ae,
...
class Ri extends te {
  constructor() {
    super(...arguments),
      t(this, "options", { fbo: null }),
      t(this, "props", { mapOffset: [0, 0], pIn0: 0, pIn1: 0 }),
      t(this, "propsAnim", { rotIn: [0, 0, 0], rotMotion: [0, 0, 0] });
  }
  async onSetup() {
    const { useMask: e } = this.options;
  ...
  getAnimIn() {
    return i
      .timeline({})
      .fromTo(
        this.propsAnim.rotIn,
        { 1: this.props.rInit || 0.5 * Math.PI },
        { 1: 0, duration: Xt ? 3 : 1.5, ease: "power2.out" },
        0
      );
  }
  async setupPass() {
    const { fbo: e } = this.options,
      { mapOffset: t, mapScale: s } = this.props;
    this.vMapOffset = new de().fromArray(t);
    const i = new Le({
      vertexShader: Wt,
      fragmentShader: `\n        varying vec2 vUv;    \n        uniform sampler2D tMap;\n        uniform vec2 uMapOffset;\n        uniform float uMapScale;\n        ${is}\n        void main() {\n          vec2 st = vUv;\n          st += uMapOffset;\n          st = scale(st, 1. / uMapScale);\n          vec4 tDiffuse = texture2D(tMap, st);\n          vec3 c = tDiffuse.rgb;\n          float a = tDiffuse.a;\n          if(a < 0.5) discard;\n          gl_FragColor = vec4(c, a);\n        }`,
      uniforms: {
        tMap: { value: e ? e.texture : null },
        uMapOffset: { value: this.vMapOffset },
        uMapScale: { value: s || 1 },
      },
    });
    this.pass = new si(It.getRenderer(), { shader: i });
  }
  async setupMesh() {
    const { idPath: e } = this.options;
    this.mesh = await new gs().setup({
      options: { addTo: this.object, idPath: e },
      props: {},
    });
  }
  setV() {
  ...
  update() {
    const { rotIn: e, rotMotion: t } = this.propsAnim,
      { delta: s } = It.getInstance(),
      { width: i, height: o } = this.props.viewport,
      { x: n, y: a } = this.pointer;
    ...
    const r = 0.25,
      ...
      c = 1 * jt(p, 0, o, -r, r),
      h = 1 * jt(l, 0, i, -r, r);
    (t[0] = me.damp(t[0], c, 3, s)),
      (t[1] = me.damp(t[1], h, 3, s)),
      (this.props.rX = e[0] + t[0]),
      (this.props.rY = e[1] + t[1]);
  }
  renderMask() {
    const { renderer: e, perspCamera: t } = It.getInstance(),
      { orthoCamera: s, scene: i } = this.pass,
      { scene: o } = this.options;
    e.clearStencil(),
      e.clearDepth(),
      (this.object.visible = this.props.v),
      bs({ renderer: e, scene: o, layer: Ot.STENCIL, camera: t }),
      xs({ renderer: e, scene: i, layer: Ot.MAIN, camera: s }),
      Ss(e),
...
class Ei extends te {
  constructor() {
    super(...arguments),
      ...
      >
        ...
        distOrbitDefault: 0.014 * Math.PI,
        data: gi("factions"),
        maxLayers: 10,
        posInit: [0, Xt ? 0.1 : 0, 0],
        cBackground: 7493214,
      }),
      t(this, "props", {
        active: (e) => e.enter && e.time > 0.46 * T().state.vh,
          ...
          : [
              {
                ...
                options: {
                  fps: 25,
                  spritesheets: { id: "sheetLeftHand", amount: 2 },
                  sequences: [{ id: "default", from: 0, to: 48, loop: -1 }],
                },
              },
              {
                id: "energy_right_fx",
                ...
                options: {
                  fps: 25,
                  spritesheets: { id: "sheetRightHand", amount: 2 },
                  sequences: [{ id: "default", from: 0, to: 48, loop: -1 }],
                },
              },
            ]
      ...
      t(this, "assets", {
        gltf: `${V.gltfBaseFolder}tableaux-factions/tableaux-factions-${
          Xt ? "mobile" : V.textureSize
        }${V.hasMobileFallback ? "-fallback" : ""}.glb`,
        ...(V.hasMobileFallback
          ? {}
          : {
              sheetLeftHand0:
                "/images/tableau/factions/energy-left/energy-left-0.json#json",
              sheetLeftHand1:
                "/images/tableau/factions/energy-left/energy-left-1.json#json",
              sheetRightHand0:
                "/images/tableau/factions/energy-right/energy-right-0.json#json",
              sheetRightHand1:
                "/images/tableau/factions/energy-right/energy-right-1.json#json",
  ...
  async onAfterSetup() {
    this.options.useControls && (this.camera.position.z = 1),
      (this.tlStory = this.getAnimStory());
  }
  async setupCards() {
    const e = 0.1 * Math.PI,
    ...
    this.card = await new gs().setup({
      ...
      props: {
        ...
        pOut: () => this.props.pOut,
        pMotion: (e) =>
          jt(e.pIn, 0.75, 1, 1, 0, !0) + jt(e.pOut, 0, 0.25, 0, 1, !0),
        pY: (e) => es(e.pIn, 1.1 * -e.s[1], 0) + es(e.pOut, 0, 1.1 * e.s[1]),
        pZ: (e) => es(e.pIn, -1.3, 0) + es(e.pOut, 0, -1.3),
        rMotion: [0, 0, 0],
        rX: (t) =>
          es(t.pIn, e, 0) + es(t.pOut, 0, -e) + t.rMotion[0] * t.pMotion,
        rY: (e) => e.rMotion[1] * e.pMotion,
  ...
  setProgress(e) {
    const { screenUnit: t, progress: s } = this.props,
      i = jt(s, 0, t, 0, 1, !0),
      o = jt(s, 1 - t, 1, 0, 1, !0);
    (this.propsAnim.ppRot =
      es(i, 0.5 * -Math.PI, 0.5 * Math.PI) + es(o, 0, 0.5 * Math.PI)),
      (this.propsAnim.ppAmount = es(i, 1, 0) + es(o, 0, 1)),
      (this.vCamWrap0.y = es(e, 0.3, -0.3));
  }
  setTime(e) {
    var t;
  ...
  render() {
    var e, t, s;
    const { renderer: i, perspCamera: o, orthoCamera: n } = It.getInstance(),
      { useMask: a } = this.options;
    a
      ? ((this.props.play && Xt) ||
          (this.pass && (i.setRenderTarget(this.pass.fbo.write), i.clear()),
          i.clearDepth(),
          i.clearStencil(),
          bs({ renderer: i, layer: Ot.STENCIL, camera: o, scene: this.scene }),
          xs({ renderer: i, layer: Ot.BG, camera: n, scene: this.scene }),
          xs({
            renderer: i,
            layer: Ot.MAIN,
            camera: this.camera,
        ...
        null == (e = this.pass) || e.render(!0, { clear: !0 }))
      : (this.pass && i.setRenderTarget(this.pass.fbo.write),
        i.clear(),
        n.layers.set(Ot.BG),
        i.render(this.scene, n),
        o.layers.set(Ot.MAIN),
        i.render(this.scene, this.camera),
        i.setRenderTarget(null),
        null == (t = this.pass) || t.render(!0)),
      null == (s = this.secondLayer) || s.render();
  }
}
Dt(Ei, [
  Ai,
...
class Di extends te {
          ...
          : [
              {
                ...
                options: {
                  fps: 30,
                  spritesheets: { id: "sheetBeam", amount: 5 },
                  sequences: [{ id: "default", from: 0, to: 59, loop: -1 }],
                },
              },
              {
                ...
                options: {
                  fps: 30,
                  spritesheets: { id: "sheetMagic", amount: 1 },
                  sequences: [{ id: "default", from: 0, to: 40, loop: -1 }],
                },
              },
              { id: "sky_glow_fx", class: Oi, options: {} },
            ]),
      ]),
      t(this, "assets", {
        gltf: `${V.gltfBaseFolder}tableaux-universe/tableaux-universe-${
          Xt ? "mobile" : V.textureSize
        }${V.hasMobileFallback ? "-fallback" : ""}.glb`,
        ...(V.hasMobileFallback
          ? {}
  ...
  async onAfterSetup() {
    this.options.useControls && (this.camera.position.z = 10),
      (this.tlStory = this.getAnimStory());
  }
  async setupCards() {
    const e = 0.1 * Math.PI,
    ...
    this.card = await new gs().setup({
      ...
      props: {
        ...
        pMotion: (e) =>
          jt(e.pIn, 0.75, 1, 1, 0, !0) + jt(e.pOut, 0, 0.25, 0, 1, !0),
        pY: (e) =>
          es(e.pIn, 1.1 * -e.s[1], 0) +
          es(e.pOut, 0, e.s[1] * (Xt ? 1.4 : 1.2)),
        pZ: (e) => es(e.pIn, -1.3, 0) + es(e.pOut, 0, -1.3),
        rMotion: [0, 0, 0],
        rX: (t) =>
          es(t.pIn, e, 0) + es(t.pOut, 0, -e) + t.rMotion[0] * t.pMotion,
  ...
  setProgress(e) {
    ...
    (this.propsAnim.ppRot =
      es(i, 0.5 * -Math.PI, 0.5 * Math.PI) + es(o, 0, 0.5 * Math.PI)),
      (this.propsAnim.ppAmount = es(i, 1, 0) + es(o, 0, 1)),
      this.vCamWrap0.set(0, es(e, 0.25, -0.2), 0);
  }
  setTime(e) {
    var t;
    null == (t = this.tlStory) || t.seek(e);
...
const Bi = ({ options: e }) => re` <section class="homeLaunch homeLaunch--${
  e.state
} homeSection">
...
class Ui extends te {
  constructor() {
    super(...arguments),
      t(this, "options", { template: Bi, id: "launch", state: "buy" }),
      t(this, "props", {
        viewport: () => T().state.viewport,
        count: !1,
        time: 0,
      }),
      t(this, "propsAnim", { counterPr: 0 }),
      t(this, "assets", {
      ...
      t(this, "scrollTo", (e) => {
        const t = document.querySelector(e),
          s = t
            ? document.documentElement.scrollTop + t.getBoundingClientRect().top
            : 0,
          o = 3e-4 * Math.abs(s - document.documentElement.scrollTop);
        i.to(window, { duration: o, scrollTo: s, ease: "power2.out" });
      }),
      t(this, "handleCounterUpdate", () => {
        const { copy: e } = this.options,
          t = Qt(Math.round(es(this.propsAnim.counterPr, 0, e.Launch_Day))),
          s = Qt(Math.round(es(this.propsAnim.counterPr, 0, e.Launch_Month)));
        "launch" == this.options.state &&
          ((this.ui.date0.innerText = t), (this.ui.date1.innerText = s));
      });
  }
  async onSetup() {
    (this.pinEl = this.ui.pin),
      (this.bigText = this.el.querySelectorAll(".js-bigText")),
      (this.scene = new ye()),
      await this.setupUI(),
      await this.setupCards();
  }
  async setupCards() {
    const { uiContainer: e } = x,
      { copy: t } = this.options;
    (this.cardsContainerWrap = new fe()),
      (this.cardsContainer = new pe()),
      (this.cardsContainer.position.x = -0.08),
      this.cardsContainer.scale.setScalar(Xt ? 0.9 : 1.3),
      this.scene.add(this.cardsContainerWrap),
      this.cardsContainerWrap.add(this.cardsContainer);
    const s = [
      {
        pos: [0, 0.08, 0],
        sObject: 0.4,
  ...
  async setupUI() {
    const { state: e, copy: t } = this.options;
    (this.lines = this.el.querySelectorAll(".js-line")),
      (this.caption = await new D().setup({
        options: {
      ...
      (this.body = await new I().setup({ options: { el: this.ui.body } }));
  }
  setupTimeline() {
    this.tl && (this.options.tl.remove(this.tl), this.tl.kill());
    const { state: e } = this.options,
      t = "launch" === e,
      { start: s, end: o } = this.props,
      { vh: n, vh100: a } = T().state,
      { perspCamera: r } = It.getInstance(),
      [l, p] = Nt(0, r),
      c = this.cards.map((e) => e.propsAnim),
      h = ((a / 2 - n / 2) / a) * p,
      d = o - n,
      u = o - s,
      m = s + 0,
      f = n * (Xt ? 1.5 : 1),
      v = m + 0.7 * n,
      g = (this.tl = i.timeline());
    g.fromTo(
      this.bigText,
      { y: t ? n : 0.15 * n },
      { y: 0, duration: f, ease: "power3.out" },
      m
    ),
      g
        .fromTo(
          this.lines,
          { alpha: 0 },
          { alpha: 1, duration: 0.3 * n },
          m + 0.7 * n
        )
        .to(this.lines, { alpha: 0, duration: 0.2 * n }, d),
      Xt
        ? (this.cardsContainerWrap.position.y = h)
        : g.fromTo(
            this.cardsContainerWrap.position,
            { y: -0.15 + h },
            { y: 0.05 + h, duration: u, ease: "none" },
            s
          ),
      c.forEach((e, t) => {
        const s = 20 * t;
        g.fromTo(
          e.rotIn,
          { 1: 0.6 * Math.PI },
          { 1: 0, duration: 0.5 * n, ease: "power3.out" },
          m + 0.3 * n + s
        );
      }),
      g.fromTo(
        this.cardsContainer.position,
        { y: -1 },
        { y: 0, duration: n, ease: "power3.out" },
        m
      ),
      g
        .add(() => {
          var e, t, s;
          null == (e = this.caption) || e.hide(),
            null == (t = this.button) || t.hide(),
            null == (s = this.body) || s.hide({ speed: 0.5 }),
            (this.props.count = !1);
        }, v - 1)
        .add(() => {
          var e, t, s;
          null == (e = this.caption) || e.show(),
            null == (t = this.button) || t.show(),
            null == (s = this.body) || s.show({ speed: 0.5, delay: 0.1 }),
            (this.props.count = !0);
        }, v)
        .add(() => {
        ...
        .to(this.ui.grid, { y: -n, duration: n, ease: "none" }, d);
    const w = d - 0.2 * n;
    c.forEach((e, t) => {
      const s = 10 * t;
      g.to(
        e.rotIn,
        { 1: -0.65 * Math.PI, duration: 0.5 * n, ease: "power2.in" },
        w + s
      );
    }),
      g.to(
        this.cardsContainer.position,
        { y: 0.3, duration: 0.5 * n, ease: "power2.in" },
        w
      ),
      g.seek(0.001),
      this.cards.forEach((e) => e.update()),
      this.options.tl.add(g, 0);
  }
  setCount(e) {
    i.killTweensOf(this.propsAnim, "counterPr"),
      i.to(this.propsAnim, {
        counterPr: 0 | e,
        duration: 0.6,
        onUpdate: this.handleCounterUpdate,
  ...
  resize(e) {
    const { height: t } = e;
    this.options.debug &&
      ((this.props.start = this.st.start + t),
      (this.props.end = this.st.end + 3 * t)),
      this.setupTimeline(),
      this.cards.forEach((t) => t.resize(e));
  }
  whileEnter() {
    this.render();
  }
  ...
  onDestroy() {
    var e;
    null == (e = this.tl) || e.kill(),
      this.cards.forEach((e) => e.destroy()),
      (this.cards = null),
      this.scene.traverse((e) => {
        var t, s, i, o, n, a;
        null ==
          (o =
            ...
            (i =
              ...
              ? void 0
              : i.value) || o.dispose(),
          null == (n = e.geometry) || n.dispose(),
          null == (a = e.material) || a.dispose();
      });
...
class Ni extends te {
  constructor() {
    super(...arguments),
      t(this, "options", {
        template: ({ context: e, options: t }) => re`<div
      ...
      t(this, "props", { v: !1, active: !1, mapOffset: [0, 0] }),
      t(this, "propsAnim", {
        rotIn: [0, 0, 0],
        rotMotion: [0, 0, 0],
        sMotion: 0,
      ...
      t(this, "onClick", () => {
        const { cbClick: e } = this.options;
        e && e();
      }),
      t(this, "onPointerOver", () => {
        i.killTweensOf(this.propsAnim, "posMotion"),
          i.to(this.propsAnim, {
            sMotion: 0.02,
            duration: 1,
            ease: "power2.out",
      ...
      t(this, "onPointerOut", () => {
        i.killTweensOf(this.propsAnim, "sMotion"),
          i.to(this.propsAnim, { sMotion: 0, duration: 1, ease: "power2.out" }),
          i.to(this.propsAnim, {
            purple: 0,
            duration: 0.7,
            ease: "power2.out",
  ...
  async onSetup() {
    (this.pointer = s()),
      (this.vOffset = new Pe()),
      (this.vMapPos = new de()),
      (this.vMapSize = new de()),
      (this.vResolution = new de()),
      (this.object = new fe()),
      (this.object.visible = !1),
      this.options.addTo.add(this.object),
      await this.setupMesh(),
      Xt || (await this.setupCaption());
  }
  async setupCaption() {
    const { idTableau: e } = this.options;
    this.caption = await new D().setup({
      options: { appendTo: this.el, text: e, textClass: "captionCard" },
    });
  }
  async setupMesh() {
    const { map: e, idPath: t } = this.options,
      { mapOffset: s } = this.props;
    ...
    const i = (this.shader = new Le({
      ...
      uniforms: {
        tMap: { value: e },
        uResolution: { value: this.vResolution },
        uResMap: { value: [e.image.width, e.image.height] },
        uMapOffset: { value: this.vMapOffset },
        uMapPos: { value: this.vMapPos },
        uMapSize: { value: this.vMapSize },
        uPurple: { value: 0 },
      },
    }));
    this.card = await new gs().setup({
      options: { addTo: this.object, layer: Ot.MAIN, idPath: t, shader: i },
      props: {},
    });
  }
  setActive(e, { firstTrigger: t }) {
    ...
    t ||
      (e
        ? null == (s = this.caption) || s.show()
        : null == (i = this.caption) || i.hide());
  }
  whileV() {
    this.update();
  }
  ...
  resize({ width: e, height100vh: t, dpr: s }) {
    T().state;
    const { perspCamera: i } = It.getInstance(),
      { sObject: o } = this.props,
      n = this.card.vSize,
      a = Math.min(n.x / n.y, n.y / n.x),
      r = Math.min(t / 800, e / 800);
    this.object.scale.setScalar(o);
    const [l, p] = Nt(this.props.pos[2], i);
    (this.props.w = e * ((1 / l) * (Xt ? 0.4 : 0.5)) * (n.x < n.y ? a : 1)),
      (this.props.h = t * ((1 / p) * (Xt ? 0.4 : 0.5)) * (n.y < n.x ? a : 1)),
      this.vResolution.set(e, t).multiplyScalar(s),
      this.vMapSize.set((Xt ? 800 : 600) * r, 1);
  }
  updateLayout() {
    const { width: e, height100vh: t, dpr: s } = this.props.viewport,
      { perspCamera: i } = It.getInstance(),
      [o, n] = Ht(this.object, i, { width: e, height: t });
    (this.props.pX = o),
      (this.props.pY = -n),
      this.vMapPos.set(o, -n).multiplyScalar(s);
  }
  updateMotion() {
    const { rotIn: e, rotMotion: t, sMotion: s } = this.propsAnim,
      { delta: i } = It.getInstance(),
      { width: o, height: n } = this.props.viewport,
      { x: a, y: r } = this.pointer,
      { pos: l, sObject: p } = this.props;
    ...
    const c = 0.3,
      ...
      u = 1 * jt(d, 0, n, -c, c),
      m = 1 * jt(h, 0, o, -c, c);
    (t[0] = me.damp(t[0], u, 3, i)),
      (t[1] = me.damp(t[1], m, 3, i)),
      this.object.position.fromArray(l),
      this.object.scale.setScalar(p + s),
      this.object.rotation.set(e[0] + t[0], e[1] + t[1], 0);
  }
  updateFx() {
    const { purple: e } = this.propsAnim;
...
function zi(e, t) {
  ...
  if (t === Be || t === Ue) {
    ...
    if (t === Be)
      for (let e = 1; e <= i; e++)
        o.push(s.getX(0)), o.push(s.getX(e)), o.push(s.getX(e + 1));
    else
      for (let e = 0; e < i; e++)
        e % 2 == 0
          ? (o.push(s.getX(e)), o.push(s.getX(e + 1)), o.push(s.getX(e + 2)))
          : (o.push(s.getX(e + 2)), o.push(s.getX(e + 1)), o.push(s.getX(e)));
    o.length;
    const n = e.clone();
...
class Gi {
  constructor(e) {
    (this.parser = e),
      (this.name = Hi.KHR_LIGHTS_PUNCTUAL),
  ...
  _loadLight(e) {
        ...
        (a = new $e(r)),
          ...
          (n.spot.outerConeAngle =
            void 0 !== n.spot.outerConeAngle
              ? n.spot.outerConeAngle
              : Math.PI / 4),
          (a.angle = n.spot.outerConeAngle),
          (a.penumbra = 1 - n.spot.innerConeAngle / n.spot.outerConeAngle),
    ...
    return (
      ...
      (a.decay = 2),
      Lo(a, n),
      void 0 !== n.intensity && (a.intensity = n.intensity),
      (a.name = t.createUniqueName(n.name || "light_" + e)),
      (i = Promise.resolve(a)),
      t.cache.add(s, i),
      i
    );
  ...
  extendParams(e, t, s) {
    ...
    if (o) {
      ...
      void 0 !== o.baseColorTexture &&
        i.push(s.assignTexture(e, "map", o.baseColorTexture, Xe));
    }
  ...
  extendMaterialParams(e, t) {
    ...
    if (
      ...
      void 0 !== n.clearcoatTexture &&
        o.push(s.assignTexture(t, "clearcoatMap", n.clearcoatTexture)),
      ...
      void 0 !== n.clearcoatNormalTexture &&
        (o.push(
          s.assignTexture(t, "clearcoatNormalMap", n.clearcoatNormalTexture)
        ),
...
class Ki {
  ...
  extendMaterialParams(e, t) {
    ...
    const o = [],
      n = i.extensions[this.name];
    return (
      void 0 !== n.iridescenceFactor && (t.iridescence = n.iridescenceFactor),
      void 0 !== n.iridescenceTexture &&
        o.push(s.assignTexture(t, "iridescenceMap", n.iridescenceTexture)),
...
class Wi {
  ...
  extendMaterialParams(e, t) {
    ...
    return (
      void 0 !== n.sheenColorFactor &&
        t.sheenColor.fromArray(n.sheenColorFactor),
      void 0 !== n.sheenRoughnessFactor &&
        (t.sheenRoughness = n.sheenRoughnessFactor),
      void 0 !== n.sheenColorTexture &&
        o.push(s.assignTexture(t, "sheenColorMap", n.sheenColorTexture, Xe)),
      void 0 !== n.sheenRoughnessTexture &&
        o.push(
          s.assignTexture(t, "sheenRoughnessMap", n.sheenRoughnessTexture)
        ),
      Promise.all(o)
    );
  }
  ...
  extendMaterialParams(e, t) {
    ...
    return (
      ...
      void 0 !== n.transmissionTexture &&
        o.push(s.assignTexture(t, "transmissionMap", n.transmissionTexture)),
      Promise.all(o)
    );
  }
}
  ...
  extendMaterialParams(e, t) {
    ...
    (t.thickness = void 0 !== n.thicknessFactor ? n.thicknessFactor : 0),
      void 0 !== n.thicknessTexture &&
        o.push(s.assignTexture(t, "thicknessMap", n.thicknessTexture)),
...
class Ji {
  ...
  extendMaterialParams(e, t) {
    ...
    const o = [],
      n = i.extensions[this.name];
    (t.specularIntensity = void 0 !== n.specularFactor ? n.specularFactor : 1),
      void 0 !== n.specularTexture &&
        o.push(s.assignTexture(t, "specularIntensityMap", n.specularTexture));
    const a = n.specularColorFactor || [1, 1, 1];
    return (
      (t.specularColor = new Me(a[0], a[1], a[2])),
      void 0 !== n.specularColorTexture &&
        o.push(
          s.assignTexture(t, "specularColorMap", n.specularColorTexture, Xe)
        ),
      Promise.all(o)
    );
  }
    ...
    if (s.extensions && s.extensions[this.name]) {
      ...
      return i.then(function (t) {
        ...
        return o.decodeGltfBufferAsync
          ? o
              .decodeGltfBufferAsync(n, a, r, e.mode, e.filter)
              .then(function (e) {
                return e.buffer;
              })
...
class oo {
  ...
  createNodeMesh(e) {
    const t = this.parser.json,
      s = t.nodes[e];
    if (!s.extensions || !s.extensions[this.name] || void 0 === s.mesh)
      return null;
    const i = t.meshes[s.mesh];
    for (const r of i.primitives)
      if (
        r.mode !== vo.TRIANGLES &&
        r.mode !== vo.TRIANGLE_STRIP &&
        r.mode !== vo.TRIANGLE_FAN &&
        void 0 !== r.mode
      )
        return null;
          ...
          for (const n of s) {
            ...
            for (let o = 0; o < i; o++)
              a.TRANSLATION && t.fromBufferAttribute(a.TRANSLATION, o),
                a.ROTATION && s.fromBufferAttribute(a.ROTATION, o),
                a.SCALE && r.fromBufferAttribute(a.SCALE, o),
                l.setMatrixAt(o, e.compose(t, s, r));
            for (const i in a)
              "TRANSLATION" !== i &&
                "ROTATION" !== i &&
                "SCALE" !== i &&
                n.geometry.setAttribute(i, a[i]);
            fe.prototype.copy.call(l, n),
              (l.frustumCulled = !1),
...
class po {
  constructor(e, t) {
    ...
    (this.name = Hi.KHR_DRACO_MESH_COMPRESSION),
      (this.json = e),
      (this.dracoLoader = t),
...
const vo = {
  ...
  wo = { 9728: Ie, 9729: ke, 9984: gt, 9985: wt, 9986: yt, 9987: Je },
  yo = { 33071: Ce, 33648: bt, 10497: Re },
  bo = { SCALAR: 1, VEC2: 2, VEC3: 3, VEC4: 4, MAT2: 4, MAT3: 9, MAT4: 16 },
  xo = {
    POSITION: "position",
    NORMAL: "normal",
    TANGENT: "tangent",
  ...
  To = { CUBICSPLINE: void 0, LINEAR: ut, STEP: xt },
  Ao = "OPAQUE",
  _o = "MASK",
  ko = "BLEND";
function Co(e, t, s) {
...
function Mo(e) {
  ...
  return (
    (s = t
      ? "draco:" + t.bufferView + ":" + t.indices + ":" + Ro(t.attributes)
      : e.indices + ":" + Ro(e.attributes) + ":" + e.mode),
    s
  );
}
function Ro(e) {
...
class Oo {
  constructor(e = {}, t = {}) {
    ...
    "undefined" != typeof navigator &&
      ((s = !0 === /^((?!chrome|android).)*safari/i.test(navigator.userAgent)),
      (i = navigator.userAgent.indexOf("Firefox") > -1),
      (o = i ? navigator.userAgent.match(/Firefox\/([0-9]+)\./)[1] : -1)),
      "undefined" == typeof createImageBitmap || s || (i && o < 98)
        ? (this.textureLoader = new We(this.options.manager))
        : (this.textureLoader = new qe(this.options.manager)),
      this.textureLoader.setCrossOrigin(this.options.crossOrigin),
      this.textureLoader.setRequestHeader(this.options.requestHeader),
      (this.fileLoader = new ze(this.options.manager)),
  ...
  loadBuffer(e) {
    ...
    if (void 0 === t.uri && 0 === e)
      return Promise.resolve(this.extensions[Hi.KHR_BINARY_GLTF].body);
    ...
    return (
      ...
      Promise.all(o).then(function (e) {
        const o = e[0],
          ...
          c =
            void 0 !== i.bufferView
              ? s.bufferViews[i.bufferView].byteStride
              : void 0,
          h = !0 === i.normalized;
        let d, u;
        if (c && c !== l) {
          ...
          let l = t.cache.get(s);
          l ||
            ((d = new a(o, e * c, (i.count * c) / r)),
            (l = new Qe(d, c / r)),
            t.cache.add(s, l)),
            (u = new St(l, n, (p % c) / r, h));
        ...
        if (void 0 !== i.sparse) {
          ...
          for (let e = 0, i = p.length; e < i; e++) {
            ...
            if (
              (u.setX(t, c[e * n]),
              n >= 2 && u.setY(t, c[e * n + 1]),
              n >= 3 && u.setZ(t, c[e * n + 2]),
              n >= 4 && u.setW(t, c[e * n + 3]),
              n >= 5)
            )
              throw new Error(
  ...
  loadTextureImage(e, t, s) {
    ...
    const l = this.loadImageSource(t, s)
      .then(function (t) {
        (t.flipY = !1), (t.name = n.name || a.name || "");
        const s = (o.samplers || {})[n.sampler] || {};
        return (
          (t.magFilter = wo[s.magFilter] || ke),
          (t.minFilter = wo[s.minFilter] || Je),
          (t.wrapS = yo[s.wrapS] || Re),
          (t.wrapT = yo[s.wrapT] || Re),
  ...
  loadImageSource(e, t) {
    ...
    if (void 0 !== n.bufferView)
      r = s.getDependency("bufferView", n.bufferView).then(function (e) {
        l = !0;
        const t = new Blob([e], { type: n.mimeType });
    ...
    return this.getDependency("texture", s.index).then(function (n) {
      ...
      if (
        (void 0 !== s.texCoord &&
          0 != s.texCoord &&
          ("aoMap" !== t || s.texCoord),
        o.extensions[Hi.KHR_TEXTURE_TRANSFORM])
      ) {
        const e =
          void 0 !== s.extensions
            ? s.extensions[Hi.KHR_TEXTURE_TRANSFORM]
            : void 0;
        if (e) {
          const t = o.associations.get(n);
          (n = o.extensions[Hi.KHR_TEXTURE_TRANSFORM].extendTexture(n, e)),
  ...
  loadMaterial(e) {
    ...
    if ((o.extensions || {})[Hi.KHR_MATERIALS_UNLIT]) {
      ...
      void 0 !== s.baseColorTexture &&
        r.push(t.assignTexture(a, "map", s.baseColorTexture, Xe)),
        ...
        void 0 !== s.metallicRoughnessTexture &&
          (r.push(
            t.assignTexture(a, "metalnessMap", s.metallicRoughnessTexture)
          ),
          r.push(
            t.assignTexture(a, "roughnessMap", s.metallicRoughnessTexture)
          )),
    ...
    if (
      ...
      void 0 !== o.normalTexture &&
        n !== ce &&
        (r.push(t.assignTexture(a, "normalMap", o.normalTexture)),
    ...
    return (
      void 0 !== o.occlusionTexture &&
        n !== ce &&
        (r.push(t.assignTexture(a, "aoMap", o.occlusionTexture)),
        void 0 !== o.occlusionTexture.strength &&
          (a.aoMapIntensity = o.occlusionTexture.strength)),
      void 0 !== o.emissiveFactor &&
        n !== ce &&
        (a.emissive = new Me().fromArray(o.emissiveFactor)),
      void 0 !== o.emissiveTexture &&
        n !== ce &&
        r.push(t.assignTexture(a, "emissiveMap", o.emissiveTexture, Xe)),
  ...
  loadGeometries(e) {
    ...
    function o(e) {
      return s[Hi.KHR_DRACO_MESH_COMPRESSION]
        .decodePrimitive(e, t)
        .then(function (s) {
          return Fo(s, e, t);
        });
    ...
    for (let a = 0, r = e.length; a < r; a++) {
      ...
      if (l) n.push(l.promise);
        ...
        let e;
        (e =
          s.extensions && s.extensions[Hi.KHR_DRACO_MESH_COMPRESSION]
            ? o(s)
            : Fo(new at(), s, t)),
          (i[r] = { primitive: s, promise: e }),
          n.push(e);
      }
    }
  ...
  loadMesh(e) {
    ...
    for (let l = 0, p = n.length; l < p; l++) {
      const e =
        void 0 === n[l].material
          ? (void 0 === (r = this.cache).DefaultMaterial &&
              (r.DefaultMaterial = new it({
                color: 16777215,
                emissive: 0,
                metalness: 1,
                roughness: 1,
            ...
            r.DefaultMaterial)
          : this.getDependency("material", n[l].material);
      a.push(e);
    }
    var r;
    return (
      ...
      Promise.all(a).then(function (s) {
        ...
        for (let c = 0, h = r.length; c < h; c++) {
          ...
          if (
            p.mode === vo.TRIANGLES ||
            p.mode === vo.TRIANGLE_STRIP ||
            p.mode === vo.TRIANGLE_FAN ||
            void 0 === p.mode
          )
            (h = !0 === o.isSkinnedMesh ? new rt(s, d) : new ue(s, d)),
              !0 === h.isSkinnedMesh && h.normalizeSkinWeights(),
              p.mode === vo.TRIANGLE_STRIP
                ? (h.geometry = zi(h.geometry, Ue))
                : p.mode === vo.TRIANGLE_FAN &&
                  (h.geometry = zi(h.geometry, Be));
          ...
          Object.keys(h.geometry.morphAttributes).length > 0 && Po(h, o),
            (h.name = t.createUniqueName(o.name || "mesh_" + e)),
            Lo(h, o),
            p.extensions && Co(i, h, p),
    ...
    if (i)
      return (
        "perspective" === s.type
          ...
          : "orthographic" === s.type &&
            (t = new xe(-i.xmag, i.xmag, i.ymag, -i.ymag, i.znear, i.zfar)),
  ...
  loadAnimation(e) {
    ...
    return Promise.all([
      ...
      for (let e = 0, t = i.length; e < t; e++) {
        ...
        let d;
        switch ((t.updateMatrix(), So[h.path])) {
          case So.weights:
            d = _t;
            break;
          case So.rotation:
        ...
        const u = t.name ? t.name : t.uuid,
          m = void 0 !== c.interpolation ? To[c.interpolation] : ut,
          f = [];
        So[h.path] === So.weights
        ...
        for (let e = 0, i = f.length; e < i; e++) {
          const t = new d(f[e] + "." + So[h.path], s.array, v, m);
          "CUBICSPLINE" === c.interpolation &&
            ((t.createInterpolant = function (e) {
              return new (this instanceof At ? fo : uo)(
                this.times,
                this.values,
                this.getValueSize() / 3,
                e
      ...
      const p = t.name ? t.name : "animation_" + e;
      return new mt(p, void 0, l);
    });
  }
  createNodeMesh(e) {
    const t = this.json,
    ...
    return void 0 === i.mesh
      ? null
      : s.getDependency("mesh", i.mesh).then(function (e) {
  ...
  _loadNodeShallow(e) {
    ...
    return (
      ...
      (this.nodeCache[e] = Promise.all(a).then(function (t) {
        ...
        if (
          (o.name && ((a.userData.name = o.name), (a.name = n)),
          Lo(a, o),
          o.extensions && Co(s, a, o),
          void 0 !== o.matrix)
        ) {
          const e = new Ye();
  ...
  loadScene(e) {
    const t = this.extensions,
      ...
      i = this,
      o = new pe();
    s.name && (o.name = i.createUniqueName(s.name)),
      Lo(o, s),
      s.extensions && Co(t, o, s);
    const n = s.nodes || [],
      a = [];
    for (let r = 0, l = n.length; r < l; r++)
      a.push(i.getDependency("node", n[r]));
    return Promise.all(a).then(function (e) {
      for (let t = 0, s = e.length; t < s; t++) o.add(e[t]);
      return (
        (i.associations = ((e) => {
          const t = new Map();
          for (const [s, o] of i.associations)
            (s instanceof tt || s instanceof Oe) && t.set(s, o);
          return (
            e.traverse((e) => {
  ...
  return (
    ...
    (function (e, t, s) {
      ...
      if (void 0 === i.POSITION) return;
      {
        ...
        if (
          (o.set(new Pe(t[0], t[1], t[2]), new Pe(n[0], n[1], n[2])),
          e.normalized)
        ) {
        ...
        ? (function (e, t, s) {
            ...
            for (let p = 0, c = t.length; p < c; p++) {
              ...
              if (i) {
                const t =
                  void 0 !== c.POSITION
                    ? s.getDependency("accessor", c.POSITION)
              ...
              if (o) {
                const t =
                  void 0 !== c.NORMAL
                    ? s.getDependency("accessor", c.NORMAL)
                    : e.attributes.normal;
                r.push(t);
              }
              if (n) {
                const t =
                  void 0 !== c.COLOR_0
                    ? s.getDependency("accessor", c.COLOR_0)
                    : e.attributes.color;
                l.push(t);
              }
            }
            return Promise.all([
              ...
              const s = t[0],
                ...
                r = t[2];
              return (
                i && (e.morphAttributes.position = s),
                o && (e.morphAttributes.normal = a),
                n && (e.morphAttributes.color = r),
...
class Bo extends te {
  ...
  async onSetup() {
    ...
    (this.mesh = new ue(Yt, s)),
      this.mesh.layers.set(t),
      this.object.add(this.mesh);
  }
  setColor(e) {
...
class Uo extends te {
  constructor() {
    super(...arguments),
      ...
      t(this, "props", { active: !1, viewport: [1, 1] }),
      t(this, "assets", {});
  }
  async onSetup() {
  ...
  async createSpritesheet() {
    const { layer: e, finalFrame: t, json: s, atlas: i } = this.options;
    this.spritesheet = await new jo().setup({
      options: {
        ...
        layer: e,
        addTo: this.object,
        data: [{ json: s, texture: i }],
        sequences: [{ id: "in", from: 0, to: t, loop: 1 }],
      },
      props: {
        aspect: [1, 1],
        s: (e) =>
          Math.max(e.aspect[0], e.aspect[1]) *
          Math.max(
            this.props.viewport[0] / e.aspect[0],
            this.props.viewport[1] / e.aspect[1]
          ),
      },
    });
  }
  async createPass() {
    this.fbo = new Se(512, 512, { minFilter: Pt, generateMipmaps: !0 });
    const e = (this.shaderBlur = new Le({
      ...
      uniforms: {
        uColor: { value: new Me(this.options.color) },
        tMap: { value: this.fbo.texture },
        uRes: { value: new de() },
        tSprite: { value: this.atlas },
      },
      transparent: !0,
      defines: { SAMPLES: Xt ? 10 : 20 },
    }));
    this.passBlur = new ds(It.getRenderer(), { shader: e });
  }
  setViewport([e, t]) {
    var s, i;
    null == (s = this.shaderBlur) || s.uniforms.uRes.value.set(e, t),
      null == (i = this.passBlur) || i.setSize(e, t);
  }
  whileActive() {
    this.spritesheet.sequence.isTicking && this.spritesheet.sequence.tick();
  }
  render(e, t = !0) {
    const { renderer: s, orthoCamera: i } = It.getInstance();
    s.setRenderTarget(this.fbo),
      i.layers.set(this.options.layer),
      s.render(e, i),
      s.setRenderTarget(null),
      this.passBlur.render(t, { clear: !0 });
  }
  resetAnimation() {
  ...
  onDestroy() {
    this.fbo.dispose(),
      this.passBlur.scene.traverse((e) => {
        var t, s, i, o, n, a;
        null ==
          (o =
            null ==
...
class jo extends te {
  constructor() {
    super(...arguments),
      t(this, "options", { useTrim: !0 }),
      t(this, "props", { uLod: 0, uniforms: (e) => ({ uLod: e.uLod }) }),
      t(this, "assets", {});
  }
  async onSetup() {
    const { useTrim: e, layer: t } = this.options,
      {
        size: s,
        frame: i,
        atlas: o,
      ...
      (l.material = new q(
        {
          fragmentShader: r,
          uniforms: {
            uRes: { value: new de(window.innerWidth, window.innerHeight) },
            uResTex: { value: Ut(s) },
            uFrame: { value: i ? Ut(i) : null },
            uSourceSize: { value: e ? Ut(n) : [] },
            uSpriteSourceSize: { value: e ? Ut(a) : [] },
            uLod: { value: 0 },
          },
        },
        { map: o, useAtlas: i, useTrim: !0 }
      )),
      i && X(l, n),
      (this.props.aspect = [n.w, n.h]),
      this.object.add(l);
  }
  setUniforms({ uLod: e }) {
  ...
  onFrame(e) {
    const t = this.frames[e],
      { quad: s } = this;
    (s.material.uTexture = t.atlas),
      (s.material.uResTex = Ut(t.size)),
      (s.material.uSourceSize = Ut(t.sourceSize)),
      (s.material.uSpriteSourceSize = Ut(t.spriteSourceSize)),
      (s.material.frame = Ut(t.frame));
  }
}
Dt(jo, [Et, W, _()]);
Dt(
  class extends te {
    ...
    async onSetup() {
      ...
      (a.blending = i),
        (a.depthTest = o),
        (a.depthWrite = n),
        (this.mesh = new ue(Yt, a)),
        this.mesh.layers.set(s),
        this.object.add(this.mesh);
    }
    setColor(e) {
...
class No extends te {
  constructor() {
    super(...arguments),
      ...
      t(this, "tweens", { gradientPr: 0, alphaOverride: 0 });
  }
  updateTweens() {
  ...
  async onSetup() {
    const { color: e } = this.props,
      ...
      s = new K({
        ...
        options: { blending: Rt, depthTest: !1, depthWrite: !1 },
      });
    (this.mesh = new ue(Yt, s)),
      this.mesh.layers.set(t),
      this.object.add(this.mesh),
      (this.sheenSound = new o.Howl({ src: ["/audio/FX_press_sheen.mp3"] }));
  }
  wipe({ duration: e = 2, delay: t = 0 } = {}) {
    this.props.wiping ||
      (i.fromTo(
        this.tweens,
        { gradientPr: 0 },
  ...
  setViewport({ width: e, height: t, height100vh: s }) {
...
Dt(
  class extends te {
    constructor() {
      super(...arguments),
        t(this, "options", { layer: Ot.UI, blending: Mt }),
        t(this, "props", { viewport: () => T().state.viewport });
    }
    async onSetup() {
      this.props;
      const { layer: e } = this.options,
        t = H.instance.assets.noiseTexture,
        s = new K({
          uniforms: {
            uNoise: t,
            uNoiseIntensity: 1,
          ...
          options: { blending: Mt, depthTest: !1, depthWrite: !1 },
        });
      (this.mesh = new ue(Yt, s)),
        this.mesh.layers.set(e),
        this.object.add(this.mesh);
...
class zo extends te {
  constructor() {
    super(...arguments),
      ...
      t(this, "downPr", 0),
      t(this, "tweenProps", { maskStart: -0.01, maskEnd: -0.01 }),
      t(this, "onTlUpdate", () => {
        this.updateTweenProps(), this.cameraSystem.updateTweenProps();
      }),
      t(this, "updateTweenProps", () => {
        (this.props.maskStart = this.tweenProps.maskStart),
          (this.props.maskEnd = this.tweenProps.maskEnd),
          (this.props.flashWipePr = this.tweenProps.flashWipePr),
          this.overlay.updateTweens();
      }),
      t(this, "handleScroll", () => {});
  }
  async onSetup() {
    (this.tweens = { cameraOffsetPr: 0 }),
      await this.setupScene(),
      await this.setupPattern(),
    ...
    (this.gltf = this.assets.gltf),
      ...
      this.gltfScene.traverse((e) => {
        ...
        if (e.material) {
          ...
          e.material.map &&
            ((e.material.map.encoding = Fe),
            (e.material = new K({
              uniforms: { uTexture: e.material.map },
              options: {},
  ...
  async setupLogo() {
    (this.kprGroup = new fe()),
      this.scene.add(this.kprGroup),
      (this.logoBehind = await new Bo().setup({
        options: { addTo: this.kprGroup, layer: Ot.BG },
        props: {
          color: "white",
      ...
      (this.logoInMask = await new Bo().setup({
        options: { addTo: this.kprGroup, layer: Ot.UI },
        props: {
          color: "white",
          maskStart: () => this.props.maskStart,
          maskEnd: () => this.props.maskEnd,
      ...
      (this.overlay = await new No().setup({
        options: { addTo: this.scene, layer: Ot.UI },
        props: { color: Ft.DARK_LAVENDER },
      }));
  }
  async setupCamera() {
    const e = Xt ? 0.1 : 0;
    (this.scene.position.x = e),
      (this.vCameraLookAt = new Pe(0, 0.18, 0)),
      (this.vCameraPosScroll = new Pe(0, 0.18, 0)),
      (this.vCameraPosPointer = new Pe(0, 0, 0)),
      (this.vCameraPos = new Pe(0, 0, 0)),
      (this.cameraSystem = await new J().setup({
        options: {
  ...
  setupTimeline() {
    const { vw: e, vh: t, vh100: s } = T().state;
    this.tl && (this.options.tl.remove(this.tl), this.tl.kill()),
      (this.tl = i.timeline({ onUpdate: this.onTlUpdate }));
    const { tl: o } = this,
      n = R("project-intro"),
      { heroBounds: a } = n,
      r = e / 2 - a.left - a.width / 2,
      l = s / 2 - a.top - a.height / 2,
      p = s,
      c = 0.5 * p;
    o.addLabel("down", n.props.start),
      o.fromTo(
        this.vCameraPosScroll,
        { z: 1.2, y: 0.18 },
        { z: 8, y: 0.3, duration: p, ease: "sine.inOut" },
        "down"
      ),
      o.fromTo(
        this.vCameraLookAt,
        { y: 0.18 },
        { y: 0.3, duration: p, ease: "sine.inOut" },
        "down"
      ),
      o.fromTo(
        this.cameraSystem.tweenProps,
        { xOffset: 0, yOffset: 0 },
        { xOffset: r, yOffset: l, duration: c, ease: "sine.inOut" },
        `down+=${c}`
      ),
      o.fromTo(
        this.overlay.tweens,
        { alphaOverride: 0 },
        { alphaOverride: 1, duration: c, ease: "sine.in" },
        "down+=" + 0 * t
      ),
      o.to(
        this.overlay.tweens,
        { alphaOverride: 0, duration: c, ease: "sine.out" },
        `down+=${c}`
      );
    const h = R("project-story");
    o.addLabel("out", h.props.start),
      o.to(
        this.vCameraPosScroll,
        { z: -2, duration: p, ease: "sine.inOut" },
        "out"
      ),
      o.fromTo(
        this.gltfScene.rotation,
        { y: 0, x: 0 },
        { y: -1.2, x: -0.5, duration: p, ease: "power3.inOut" },
        "out"
      ),
      o.to(
        this.cameraSystem.tweenProps,
        { xOffset: 0, yOffset: 0, duration: p, ease: "sine.inOut" },
        "out"
      ),
      o.to(
        this.overlay.tweens,
        { alphaOverride: 1, duration: t, ease: "sine.inOut" },
        "out"
      ),
      o.seek(0.001),
      this.options.tl.add(o, 0);
  }
  onEnter() {
  ...
  show({
    ...
    const n = "power3.inOut",
      { vh: a, vh100: r } = T().state,
      l = (this.showTl = new i.timeline({ onUpdate: this.updateTweenProps }));
    o ||
      ((this.pattern.props.active = !0),
      this.pattern.playAnimation(),
      l.to(
        this.tweenProps,
        { maskStart: 0, maskEnd: 1, duration: 2.5, delay: e, ease: "none" },
        0
      ),
      l.to(
        this.tweenProps,
        { maskStart: 1, maskEnd: 1, duration: 1, delay: s, ease: "linear" },
        0
      )),
      l.fromTo(
        this.overlay.tweens,
        { alphaOverride: 1 },
        { alphaOverride: 0, duration: 2, delay: t + 1 },
        0
      ),
      l.fromTo(
        this.kprGroup.position,
        { y: r / 2 - a / 2 },
        { y: r / 2 - a / 2 - 0.1 * a, duration: 2, delay: t + 0.5, ease: n },
        0
      ),
      l.fromTo(
        this.gltfScene.rotation,
        { y: 1 },
        { y: 0, duration: 3, delay: t, ease: n },
        0
      ),
      l.fromTo(
        this.gltfScene.scale,
        { x: 0.3, y: 0.3, z: 0.3 },
        {
          x: 1,
          y: 1,
  ...
  update() {
    Gt || (this.updatePointerMotion(), this.updatePointerDownMotion()),
      this.vCameraPos.copy(this.vCameraPosScroll).add(this.vCameraPosPointer);
  }
  updatePointerMotion() {
    const e = 0.4,
      t = jt(this.cameraSystem.theta, 0.18, -0.18, -1, 1),
      s = jt(this.cameraSystem.phi, 0.18, -0.18, -1, 1),
  ...
  render() {
    this.update();
    const { renderer: e, orthoCamera: t } = It.getInstance(),
      { persistentCard: s, useMasking: i } = this.options,
      { camera: o } = this.cameraSystem;
    return (
      this.props.showComplete || this.pattern.render(this.scene),
      e.clearDepth(),
      i
        ? (e.clearDepth(),
          e.clearStencil(),
          s.showFrontSide(),
          bs({ renderer: e, camera: s.camera, scene: s.scene }),
          xs({ renderer: e, layer: Ot.MAIN, camera: o, scene: this.scene }),
          xs({ renderer: e, layer: Ot.UI, camera: t, scene: this.scene }),
          Ss(e))
        : (o.layers.set(Ot.MAIN),
          e.render(this.scene, o),
          t.layers.set(Ot.UI),
  ...
  onPointerDown() {
    this.props.showComplete &&
      this.props.active &&
      (this.overlay.wipe(),
      i.killTweensOf(this.gltfScene.position),
      i.to(this.gltfScene.position, {
        z: -0.15,
        duration: 4,
        ease: "expo.out",
      }));
  }
  offPointerDown({ firstTrigger: e }) {
    e ||
      (i.killTweensOf(this.gltfScene.position),
      i.to(this.gltfScene.position, { z: 0, duration: 2, ease: "expo.out" }));
  }
        ...
        null == (t = e.material) || t.dispose(),
          null ==
            (n =
              null ==
              (o =
                null == (i = null == (s = e.material) ? void 0 : s.uniforms)
                  ? void 0
                  : i.uTexture)
                ? void 0
                : o.value) || n.dispose(),
          null ==
            (p =
              null ==
              (l =
                null == (r = null == (a = e.material) ? void 0 : a.uniforms)
                  ? void 0
                  : r.uGradient)
                ? void 0
                : l.value) || p.dispose(),
          null ==
            (u =
              null ==
              (d =
                null == (h = null == (c = e.material) ? void 0 : c.uniforms)
                  ? void 0
                  : h.tMap)
                ? void 0
                : d.value) || u.dispose(),
          null == (m = e.geometry) || m.dispose();
      });
    for (const s in this.assets) {
...
class $o extends te {
  constructor() {
    super(...arguments),
      ...
      t(this, "props", { active: !1 }),
      t(this, "uSize", new de()),
      t(this, "uTextureSize", new de()),
      t(this, "assets", {
        json: "/images/sheets/logo-anim-low-res-0.json#json",
        atlas: `${O}sheets/logo-anim-low-res-0.ktx2`,
      }),
      t(this, "tweenProps", { pX: 0, pY: 0, pZ: 0, rX: 0, rY: 0, rZ: 0 });
  }
  updateTweenProps() {
    (this.props.pX = this.tweenProps.pX),
      (this.props.pY = this.tweenProps.pY),
      (this.props.pZ = this.tweenProps.pZ),
      (this.mesh.rotation.x = this.tweenProps.rX),
      (this.mesh.rotation.y = this.tweenProps.rY),
      (this.mesh.rotation.z = this.tweenProps.rZ);
  }
  async onSetup() {
    const { layer: e } = this.options;
    (this.patternScene = new ye()),
      await this.setupPattern(),
      this.pattern.passBlur;
    const t = new K({
      uniforms: {
        uScale: Xt ? 0.6 : 0.9,
    ...
    (this.mesh = new ue(Yt, t)),
      this.mesh.layers.set(e),
      this.object.add(this.mesh),
      await P(this.constructor.name, this.patternScene);
  }
  async setupPattern() {
    this.pattern = await new Uo().setup({
      options: {
...
const Ho = O,
  Go = [
    { id: "female-cloth", totalSheets: 3 },
    { id: "female-hair", totalSheets: 2 },
    { id: "male-hair", totalSheets: 2 },
  ],
  Xo = {},
  Vo = Gt ? "-mobile" : "";
V.hasMobileFallback ||
  Go.forEach((e) =>
    new Array(e.totalSheets).fill().map((t, s) => {
      const i = `${e.id}${s}-json`,
        o = `${e.id}${s}-texture`,
...
class Yo extends te {
          ...
          : [
              {
                ...
                options: {
                  fps: 30,
                  spritesheets: { id: "male-hair", amount: 2 },
                  sequences: [{ id: "default", from: 0, to: 48, loop: -1 }],
                },
              },
              {
                ...
                options: {
                  fps: 30,
                  spritesheets: { id: "female-hair", amount: 2 },
                  sequences: [{ id: "default", from: 0, to: 48, loop: -1 }],
                },
              },
              {
                ...
                options: {
                  fps: 30,
                  spritesheets: { id: "female-cloth", amount: 3 },
                  sequences: [{ id: "default", from: 0, to: 48, loop: -1 }],
                },
              },
            ]),
  ...
  async setupScene() {
    ...
    const { objects: e, assets: t } = this,
      s = [];
    (this.gltfScene = this.assets.gltf.scene),
      this.gltfScene.traverse((i) => {
        if (i.isMesh && i.material) {
          const { name: o } = i.userData,
            n = e.find((e) => e.id === o),
            a = (n && n.class) || $;
          let r = null;
          if (n) {
            const { id: e, amount: s } = n.options.spritesheets;
            r = new Array(s)
              .fill()
              .map((s, i) => ({
          ...
          const l = new a().setup({
            ...
            props: { enter: () => this.props.active },
          });
          s.push(l);
        }
      }),
      this.scene.add(this.gltfScene),
      (this.sceneObjects = await Promise.all(s));
  }
  async setupCamera() {
    (this.vCameraLookAt = new Pe(0, 0, -20)),
      (this.vCameraPos = new Pe(0, 0, 1.5)),
      (this.cameraSystem = await new J().setup({
        options: { vLookAt: this.vCameraLookAt, vPos: this.vCameraPos },
        props: {
          disableInteraction: Gt,
          active: () => this.props.active,
          maxRotation: 0.2,
  ...
  async setupLogo() {
    this.logo = await new $o().setup({
      options: { addTo: this.scene, scene: this.scene, layer: Ot.UI },
    });
  }
  setupTimeline() {
    const { vw: e, vh: t, vh100: s } = T().state;
    ...
    const { tl: o } = this,
      n = R("project-story");
    if (n) {
      const { bounds: i, start: a, end: r } = n.props;
      let l = i.height + s;
      const p = 2 * s;
      o.addLabel("enter", a);
      const c = Xt ? 3 : 3.5,
      ...
      o.fromTo(
        ...
        o.fromTo(
          this.vCameraPos,
          { z: d },
          { z: u, duration: p, ease: "sine.inOut" },
          "enter"
        ),
        o.fromTo(this.vCameraLookAt, { y: c }, { y: h, duration: l }, "enter"),
        o.fromTo(this.vCameraPos, { y: c }, { y: h, duration: l }, "enter");
      const { bounds: m } = n.logoBoundingBox,
        f = e / -2 + m.left + m.width / 2;
      this.logo.props.s = [m.width, m.height, 1];
      let v = s / 2 - m.height / 2 - t - m.top;
      const g = i.height + (Xt ? 0.15 * s : 0),
        w = r - 2 * s,
        y = r - 1.5 * s,
        b = r - s;
      o.fromTo(
        this.logo.tweenProps,
        { pY: v },
        { pY: v + g, duration: g, ease: "none" },
        a
      ),
        o.add(() => (this.logo.props.active = !1), w),
        o.add(() => (this.logo.props.active = !0), y),
        o.fromTo(
          this.logo.tweenProps,
          { pX: f, rX: 0, rY: 0, rZ: 0 },
          { pX: 0.25 * -e, rX: -0.4, rY: 2, duration: s, ease: "power3.inOut" },
          b
        );
    }
    o.seek(0.001), this.options.tl.add(o, 0);
  }
  render() {
    const { renderer: e, orthoCamera: t } = It.getInstance(),
      { persistentCard: s, useMasking: i } = this.options;
    return (
      i
        ? (e.clearDepth(),
          ...
          xs({ renderer: e, layer: Ot.UI, camera: t, scene: this.scene }),
          Ss(e))
        : (e.render(this.scene, this.cameraSystem.camera),
          this.logo.render(),
          t.layers.set(Ot.UI),
          e.render(this.scene, t)),
      null
...
class Ko extends te {
  ...
  async setupScene() {
    (this.scene = new ye()),
      (this.box = new ue(Zt, Vt("#A79BED"))),
      this.box.scale.setScalar(20),
      (this.box.material.side = ve),
    ...
    (this.gltf = this.assets.gltf),
      ...
      this.gltfScene.traverse((e) => {
        ...
        e.material &&
          ...
          (e.material = new K({ uniforms: { uTexture: e.material.map } }))),
          t && (e.renderOrder = 30 - t);
      }),
      this.scene.add(this.gltfScene);
  }
  async setupCamera() {
    (this.vCameraLookAt = new Pe(-0.05, 0.1, 0)),
      (this.vCameraPos = new Pe(-0.05, 0.1, 0)),
      (this.cameraSystem = await new J().setup({
        options: { vLookAt: this.vCameraLookAt, vPos: this.vCameraPos },
        props: { active: () => this.props.active, disableInteraction: Gt },
      }));
  }
  setupTimeline() {
    const { vw: e, vh100: t, scale: s } = T().state;
    this.tl && (this.options.tl.remove(this.tl), this.tl.kill()),
      (this.tl = i.timeline({ onUpdate: this.onTlUpdate }));
    const { tl: o } = this,
      n = R("collection-intro"),
      { heroBounds: a } = n,
      r = t;
    o.addLabel("enter", n.props.start),
      o.fromTo(
        this.scene.rotation,
        { y: -0.8 },
        { y: 0, duration: r, ease: "power3.inOut" },
        "enter"
      ),
      o.fromTo(
        this.scene.position,
        { x: 0.5 },
        { x: 0, duration: r, ease: "power3.inOut" },
        "enter"
      ),
      o.fromTo(
        this.vCameraPos,
        { z: Xt ? 8 : 4.5 },
        { z: Xt ? 7 : 4, duration: r, ease: "power3.inOut" },
        "enter"
      );
    ...
    o.fromTo(
      this.cameraSystem.tweenProps,
      { xOffset: 0, yOffset: 0 },
      { xOffset: l, yOffset: p, duration: r, ease: "power3.inOut" },
      "enter"
    );
    const c = R("collection-gallery");
    o.addLabel("down", c.props.start),
      o.to(
        this.vCameraPos,
        { z: Xt ? 10 : 8, duration: 300 * s, ease: "power2.in" },
        "down"
      ),
      o.seek(0.001),
      this.options.tl.add(o, 0);
  ...
  render() {
    const { renderer: e } = It.getInstance(),
      { persistentCard: t, useMasking: s } = this.options;
    return (
      s
        ? (e.clearDepth(),
          e.clearStencil(),
          t.showFrontSide(),
          bs({ renderer: e, camera: t.camera, scene: t.scene }),
          xs({
            renderer: e,
            camera: this.cameraSystem.camera,
            scene: this.scene,
...
class Wo extends te {
  ...
  async onSetup() {}
  show({ delay: e = 0 }) {
    i.to(x.app.simpleFrame, { opacity: 1, color: 1, delay: e });
  }
  setupTimeline() {
    var e;
    null == (e = this.tl) || e.kill(),
      (this.tl = i.timeline({ onUpdate: this.onUpdate }));
    const { tl: t } = this,
      { vw: s, vh: o, scale: n } = T().state,
      { app: a } = x;
    R("project-intro");
    const r = R("project-story"),
      ...
      u = 0.2 * o;
    if (
      (t.fromTo(a.simpleFrame, { color: 1 }, { color: 0, duration: d }, u),
      t.to(a.simpleFrame, { color: 1, duration: d }, r.props.start + 0.5 * o),
      t.to(a.simpleFrame, { color: 0, duration: d }, l.props.start + 0.4 * o),
      c && t.to(a.simpleFrame, { color: 1, duration: d }, c.props.start + o),
      h &&
        t.to(a.simpleFrame, { color: 0, duration: d }, h.props.start + 0.5 * o),
      a && Xt)
    ) {
      const e = p.props.start + 0.2 * o,
        s = r.props.start + 0.7 * o,
        i = l.props.start + 0.3 * o,
        n = c.props.start + 1 * o,
        d = h.props.start + 0.5 * o;
      t.add(() => a.setNavTheme(""), 9),
        t.add(() => a.setNavTheme("white"), 10),
        t.add(() => a.setNavTheme("white"), s - 1),
        t.add(() => a.setNavTheme(""), s),
        t.add(() => a.setNavTheme(""), i - 1),
        t.add(() => a.setNavTheme("white"), i),
        t.add(() => a.setNavTheme("white"), e - 1),
        t.add(() => a.setNavTheme("purple"), e),
        t.add(() => a.setNavTheme("purple"), n - 1),
        t.add(() => a.setNavTheme(""), n),
        t.add(() => a.setNavTheme(""), d - 1),
        t.add(() => a.setNavTheme("white"), d);
    }
    t.seek(0.001), this.options.tl.add(t, 0);
  }
  onPostResize() {
    this.setupTimeline();
  }
...
class qo extends te {
  constructor() {
    super(...arguments),
      ...
      t(this, "currentSound", null),
      t(this, "setMenuActive", (e) => {
        var t;
        const s = e ? 0.3 : 1;
        null == (t = this.currentSound) || t.fade({ volume: s });
      }),
      t(this, "setVideoOverlay", (e) => {
        const t = e ? 0 : 1,
          s = e ? 0 : 0.3,
          o = e ? 1 : 2;
        i.killTweensOf(this.tweens, "homeVolume"),
          i.to(this.tweens, {
            homeVolume: t,
            delay: s,
            duration: o,
      ...
      t(this, "onSoundEnd", () => {
        ...
        e.id === this.props.currentId &&
          ((e.current = e.loopTrack),
          e.volume(0),
          e.current.play("loop"),
          e.fade({ duration: 5 }));
      }),
      t(this, "onWindUpdate", () => {
        const e = es(this.tweens.windPr, 1, 0.8),
          t = es(this.tweens.windPr, 0, 0.85);
        this.introSound.volume(e), this.windSound.volume(t);
      });
  }
  async onSetup() {
    (this.tweens = { windPr: 0, homeVolume: 1 }),
      this.setupSounds(),
      this.addEvents();
  }
  addEvents() {
    const { app: e } = x;
    e &&
      ((this.stopMenuActive = p(() => e.showMenu, this.setMenuActive)),
      (this.stopVideoOverlay = p(
        () => !!e.videoOverlay.src,
        this.setVideoOverlay
      )));
  }
  removeEvents() {
    this.stopMenuActive && this.stopMenuActive(),
      this.stopVideoOverlay && this.stopVideoOverlay();
  }
  setupSounds() {
    (this.sounds = [
      {
        id: "intro",
        src: "INTROx_song.mp3",
        loop: { src: "INTROx_AFTER_loop.mp3", start: 27, dur: 13710 },
      },
      {
        id: "keep",
        src: "TBL1_song.mp3",
        loop: { src: "TBL1_AFTER_loop.mp3", start: 27, dur: 16e3 },
      },
      {
        id: "factions",
        src: "TBL2_song.mp3",
        loop: { src: "TBL2_AFTER_loop.mp3", start: 27, dur: 21333 },
      },
      {
        id: "universe",
        src: "TBL3_song.mp3",
        loop: { src: "TBL3_AFTER_loop.mp3", start: 27, dur: 21333 },
      },
    ].map(({ id: e, src: t, loop: s }) => {
      const n = { current: null, playLoop: !1, id: e };
      return (
        (n.mainTrack = new o.Howl({
          src: [`/audio/${t}`],
        ...
        (n.loopTrack = new o.Howl({
          ...
          loop: !0,
          html5PoolSize: 1,
          sprite: { loop: [s.start, s.dur, !0] },
        })),
        (n.volume = (e) => {
          n.mainTrack.volume(e), n.loopTrack.volume(e);
        }),
        (n.fade = ({ duration: e = 1, volume: t = 1, stop: s = !1 } = {}) => {
          const o = n.current;
          o.fade(o.volume(), t, 1e3 * e),
            s &&
              i.delayedCall(e, () => {
                o.stop();
              });
      ...
      (this.introSound = this.sounds.find((e) => "intro" === e.id)),
      (this.windSound = new o.Howl({
        src: ["audio/FX_Wind.mp3"],
        volume: 0,
        loop: !0,
        sprite: { loop: [27, 8571, !0] },
      })),
  ...
  setupTimeline() {
    ...
    const t = (this.tl = i.timeline()),
      ...
      p = R("universe");
    R("launch");
    t.add(() => (this.props.currentId = "intro"), 0),
      t.add(
        () => (this.props.currentId = "intro"),
        r.props.start + 0.5 * o - 1
      ),
      t.add(() => (this.props.currentId = "keep"), r.props.start + 0.5 * o),
      t.add(() => (this.props.currentId = "keep"), l.props.start - 1),
      t.add(() => (this.props.currentId = "factions"), l.props.start),
      t.add(() => (this.props.currentId = "factions"), p.props.start - 1),
      t.add(() => (this.props.currentId = "universe"), p.props.start);
    const c = a.props.end - 2 * o;
    t.fromTo(
      this.tweens,
      { windPr: 0 },
      { windPr: 1, duration: o, onUpdate: this.onWindUpdate },
      c
    ),
      t.to(
        this.tweens,
        { windPr: 0, duration: o, onUpdate: this.onWindUpdate },
        c + o
      ),
      t.seek(0.001),
      this.options.tl.add(t, 0);
  }
  setCurrentId(e) {
    var t, s;
    if (!this.props.active) return;
    ...
    if (!n) return;
    null == (t = this.startDelay) || t.kill(),
      this.currentSound &&
        (this.currentSound.fade({ volume: 0, stop: !0 }),
        !this.transitionPlaying &&
          o.Howler._audioUnlocked &&
          (this.transitionSound.play(),
          (this.transitionPlaying = !0),
          null == (s = this.transitionDelay) || s.kill(),
          (this.transitionDelay = i.delayedCall(
            1.5,
            () => (this.transitionPlaying = !1)
          ))));
    const a = this.currentSound ? 1.3 : 0;
    this.startDelay = i.delayedCall(a, () => {
      (n.current = n.playLoop ? n.loopTrack : n.mainTrack),
        n.play(),
        (n.playLoop = !0),
        (this.currentSound = n);
    });
  ...
  onActive() {
    this.windSound.play("loop"),
      this.currentSound || this.setCurrentId(this.props.currentId);
  }
  offActive({ firstTrigger: e }) {
    e || this.windSound.pause("loop");
  }
  onSecondLayerActive() {
    this.currentSound.fade({ duration: 0.2, volume: 0.7 });
  }
  offSecondLayerActive({ firstTrigger: e }) {
    e || this.currentSound.fade({ duration: 1, volume: 1 });
  }
  onPostResize() {
    this.setupTimeline();
  }
...
const Zo = ({ options: e, props: t }) => re` <div class="homePage">
  <div
    data-ui="landingRef"
...
class Qo extends te {
  ...
  async onSetup() {
    ...
    (this.sections = o),
      (this.scenes = n),
      this.setupSceneActives(),
      (this.shellManager = await new Wo().setup({ options: { tl: this.tl } })),
      (this.sounds = await new qo().setup({ options: { tl: this.tl } })),
      this.tl.seek(0.001, !1);
  }
  setupIntroSound() {
    return new Promise((e) => {
      const t =
        (null == app ? void 0 : app.isFirstEnter) && !os.get("skipIntro")
          ? "/audio/FX_logo_intro_animation.mp3"
          : "/audio/FX_ALT_intro_animation.mp3";
      (this.introSound = new o.Howl({ src: [t] })),
        this.introSound.once("load", e);
    });
  }
  async setupSections() {
    const { uiContainer: e, canvasContainer: t, copy: s } = x,
      i = { appendTo: e, uiContainer: e, tl: this.tl },
      o = [
        {
          view: Ps,
          options: { triggerEl: this.ui.landingRef },
          copyId: "HomeLanding",
        },
        {
          view: Us,
          options: { triggerEl: this.ui.projectIntroRef },
          copyId: "HomeStoryIntro",
        },
        {
          view: Ns,
          options: { triggerEl: this.ui.projectStoryRef },
          copyId: "HomeStoryProject",
        },
        {
          view: Gs,
          options: { triggerEl: this.ui.collectionIntroRef },
          copyId: "HomeCollectionIntro",
        },
        {
          view: Qs,
          options: { triggerEl: this.ui.collectionGalleryRef },
          copyId: "HomeCollectionGallery",
        },
        {
          view: Mi,
          options: { triggerEl: this.ui.keepRef },
          copyId: "HomeTableauxKeep",
        },
        {
          view: Ei,
          options: { triggerEl: this.ui.factionsRef },
          copyId: "HomeTableauxFactions",
        },
        {
          view: Di,
          options: { triggerEl: this.ui.universeRef },
          copyId: "HomeTableauxUniverse",
        },
        {
          view: Ui,
          options: { triggerEl: this.ui.launchRef, appendTo: t },
          copyId: "HomeLaunch",
        },
      ];
    return Promise.all(
      o.map(({ view: e, options: t, copyId: s }) =>
        new e().setup({ options: { ...i, ...t, copy: vs(s) } })
      )
    );
  }
  async setupScenes() {
    const e = { persistentCard: this.persistentCard, tl: this.tl },
      t = [{ view: zo }, { view: Yo }, { view: Ko }];
    return Promise.all(
      t.map(({ view: t, props: s }) => new t().setup({ options: e, props: s }))
    );
  }
  setupSceneActives() {
    const e = R("landing"),
      ...
      n = this.scenes[1],
      a = this.scenes[2];
    (this.landingSceneActiveEffect = ie(
      () => e.props.enter || t.props.enter,
      (e) => {
        o.props.active = e;
      }
    )),
      (this.projectSceneActiveEffect = ie(
        () => s.props.enter,
        (e) => {
          n.props.active = e;
        }
      )),
      (this.collectionSceneActiveEffect = ie(
        () => i.props.enter,
        (e) => {
          a.props.active = e;
        }
  ...
  show() {
    var e;
    const { app: t } = x,
      s = !((null == t ? void 0 : t.isFirstEnter) && !os.get("skipIntro"));
    null == t || t.setEntered(!1);
    const n = s ? 0 : 3,
      a = n + 3,
      r = R("landing"),
      l = this.scenes[0];
    (this.sounds.props.active = !0),
      null == (e = this.persistentCard) || e.show({ delay: n }),
      l.show({
        skipIntro: s,
        delay: 0.5,
        maskFlipDelay: n,
      ...
      this.shellManager.show({ delay: n + 1.5 }),
      o.Howler._audioUnlocked && this.introSound.play(),
      r.show({ delay: a }),
      i.delayedCall(a, () => {
  ...
  render() {
    var e, t;
    const { renderer: s } = It.getInstance();
    return (
      s.clear(),
      null == (e = this.persistentCard) || e.update(),
      null == (t = this.persistentCard) || t.render(),
  ...
  setViewport(e) {
    this.sections.forEach((t) => t.preResize(e)),
      this.sections.forEach((t) => t.resize(e)),
      this.scenes.forEach((t) => t.resize(e)),
      oe("postResize", e);
  }
  onPostResize(e) {
  ...
  onDestroy() {
    this.tl.kill(),
      this.introSound.unload(),
      this.sections.forEach((e) => e.destroy()),
      (this.sections = []),
      this.scenes.forEach((e) => e.destroy()),
      (this.scenes = []);
  }
}
Dt(Qo, [ae]);
const Jo = {
  __name: "Home",
  props: { story: { type: Object, required: !0 } },
  emits: ["loaded"],
  setup(e, { emit: t }) {
    const s = e,
      i = c(null);
    ...
    return (
      d(async () => {
        {
          const { $gsap: e, $ScrollTrigger: t, $ScrollSmoother: i } = u(),
            { app: o } = h();
          S({
            app: o,
            gsap: e,
        ...
        k().reset(),
          ...
          (o = await new ee().setup({
            options: { appendTo: i.value, component: Qo },
          }));
      }),
      p(
        () => n.pageReady,
      ...
      (e, t) => (
        f(),
        v("div", { ref_key: "containerRef", ref: i, class: "home" }, null, 512)
      )
    );
  },
};
