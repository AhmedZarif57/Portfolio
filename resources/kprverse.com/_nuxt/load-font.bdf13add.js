...
(e = {
  ...
  (function () {
    ...
    function u(e, t) {
      ...
      return [n, i, r ? e.stretch : "", "100px", t].join(" ");
    }
        ...
        if (
          ...
          !(function (e) {
            ...
            (b.dir = "ltr"),
              ...
              b.appendChild(m.g),
              b.appendChild(p.g),
              o.context.document.body.appendChild(b),
              (x = h.g.offsetWidth),
              (y = m.g.offsetWidth),
              (E = p.g.offsetWidth),
              (function e() {
...
const n = t,
  i = async ({ fontface: e = "Arial", timeout: t = 2e3 } = {}) => {
    const i = new n(e, {});
    return new Promise((e, n) => {
      i.load(null, t).then(e, () => n("Font is not available"));
    });
  };
export { n as F, i as l };
