...
import { C as n } from "./index.6c8f1534.js";
import {
  E as o,
  a,
  h as i,
...
import { s as b } from "./store.4d67c1b5.js";
const f = { type: "change" },
  E = { type: "start" },
  g = { type: "end" };
class y extends o {
  constructor(e, t) {
    super(),
      ...
      (this.mouseButtons = { LEFT: i.ROTATE, MIDDLE: i.DOLLY, RIGHT: i.PAN }),
      ...
      (this.update = (function () {
        const t = new a(),
          i = new r().setFromUnitVectors(e.up, new a(0, 1, 0)),
          s = i.clone().invert(),
          c = new a(),
          l = new r(),
          E = 2 * Math.PI;
        return function () {
          ...
          t.copy(e).sub(n.target),
            ...
            n.enableDamping
              ? ((m.theta += d.theta * n.dampingFactor),
                (m.phi += d.phi * n.dampingFactor))
              : ((m.theta += d.theta), (m.phi += d.phi));
          let a = n.minAzimuthAngle,
            r = n.maxAzimuthAngle;
          return (
            isFinite(a) &&
              isFinite(r) &&
              (a < -Math.PI ? (a += E) : a > Math.PI && (a -= E),
              r < -Math.PI ? (r += E) : r > Math.PI && (r -= E),
              (m.theta =
                a <= r
                  ? Math.max(a, Math.min(r, m.theta))
                  : m.theta > (a + r) / 2
                  ? Math.max(a, m.theta)
                  : Math.min(r, m.theta))),
            (m.phi = Math.max(
            ...
            (m.radius = Math.max(
              n.minDistance,
              Math.min(n.maxDistance, m.radius)
            )),
            !0 === n.enableDamping
            ...
            !!(
              y ||
              c.distanceToSquared(n.object.position) > h ||
              8 * (1 - l.dot(n.object.quaternion)) > h
            ) &&
              (n.dispatchEvent(f),
        ...
        return function (t, o) {
          ...
          if (n.object.isPerspectiveCamera) {
            ...
            (s *= Math.tan(((n.object.fov / 2) * Math.PI) / 180)),
              R((2 * t * s) / a.clientHeight, n.object.matrix),
              Y((2 * o * s) / a.clientHeight, n.object.matrix);
          } else
    ...
    function z() {
      if (1 === C.length) v.set(C[0].pageX, C[0].pageY);
      else {
        const e = 0.5 * (C[0].pageX + C[1].pageX),
          t = 0.5 * (C[0].pageY + C[1].pageY);
        v.set(e, t);
      }
    }
    function F() {
      if (1 === C.length) T.set(C[0].pageX, C[0].pageY);
      else {
        const e = 0.5 * (C[0].pageX + C[1].pageX),
          t = 0.5 * (C[0].pageY + C[1].pageY);
        T.set(e, t);
    ...
    function X() {
      const e = C[0].pageX - C[1].pageX,
        t = C[0].pageY - C[1].pageY,
        n = Math.sqrt(e * e + t * t);
      A.set(0, n);
    }
    function Z(e) {
      if (1 == C.length) P.set(e.pageX, e.pageY);
      else {
        const t = ne(e),
          n = 0.5 * (e.pageX + t.x),
          o = 0.5 * (e.pageY + t.y);
      ...
      O.subVectors(P, v).multiplyScalar(n.rotateSpeed);
    ...
    function U(e) {
      if (1 === C.length) w.set(e.pageX, e.pageY);
      else {
        const t = ne(e),
          n = 0.5 * (e.pageX + t.x),
          o = 0.5 * (e.pageY + t.y);
      ...
      L.subVectors(w, T).multiplyScalar(n.panSpeed), D(L.x, L.y), T.copy(w);
    }
    function V(e) {
      const t = ne(e),
        o = e.pageX - t.x,
        ...
        i = Math.sqrt(o * o + a * a);
      j.set(0, i),
        M.set(0, Math.pow(j.y / A.y, n.zoomSpeed)),
        I(M.y),
        A.copy(j);
    }
    function B(e) {
          ...
          ? (function (e) {
              switch ((te(e), p)) {
                ...
                case o.TOUCH_DOLLY_PAN:
                  if (!1 === n.enableZoom && !1 === n.enablePan) return;
                  !(function (e) {
                    n.enableZoom && V(e), n.enablePan && U(e);
                  })(e),
                    n.update();
                  break;
                ...
                case o.PAN:
                  ...
                  !(function (e) {
                    w.set(e.clientX, e.clientY),
                      L.subVectors(w, T).multiplyScalar(n.panSpeed),
                      D(L.x, L.y),
                      T.copy(w),
                      n.update();
                  })(e);
    ...
    function W(e) {
      !1 !== n.enabled &&
        ...
        n.dispatchEvent(E),
        (function (e) {
          e.deltaY < 0 ? _(N()) : e.deltaY > 0 && I(N()), n.update();
        })(e),
        n.dispatchEvent(g));
    }
    function $(e) {
    ...
    function ee(e) {
      ...
      for (let t = 0; t < C.length; t++)
        if (C[t].pointerId == e.pointerId) return void C.splice(t, 1);
    }
    function te(e) {
      let t = x[e.pointerId];
      void 0 === t && ((t = new l()), (x[e.pointerId] = t)),
        t.set(e.pageX, e.pageY);
    }
    function ne(e) {
      const t = e.pointerId === C[0].pointerId ? C[1] : C[0];
...
const v = class extends n {
  constructor() {
    super(...arguments),
      t(this, "options", { appendTo: document.body }),
      t(this, "props", {
        active: !0,
        width: 1,
        height: 1,
        viewport: () => b().state.viewport,
        fov: 32,
        moveSpeed: 0.1,
      });
  }
  async onSetup() {
    const { width: e, height: t } = this.props.viewport;
    (this.clock = new p()),
      (this.delta = 0),
      (this.renderer = new h({ antialias: !1 })),
      this.renderer.setPixelRatio(b().state.dpr),
      this.renderer.setSize(e, t),
      this.renderer.setClearColor(0),
      this.renderer.setClearAlpha(0),
      (this.renderer.autoClear = !1),
      this.options.appendTo.appendChild(this.renderer.domElement),
      (this.scene = new m()),
  ...
  async setupCameras() {
    const { width: e, height: t } = this.props.viewport;
    (this.orthoCamera = new d(1, 1, 1, 1, 0.1, 30)),
      this.orthoCamera.position.set(0, 0, 2),
      (this.perspCamera = new u(32, e / t, 0.1, 50)),
      this.perspCamera.position.set(0, 0, 2),
      (this.controls = new y(this.perspCamera, this.renderer.domElement)),
      (this.controls.enabled = !1);
  }
  render() {
    this.delta = this.clock.getDelta();
  }
  setViewport({ width: e, height: t, height100vh: n, dpr: o }) {
    this.renderer.setSize(e, n),
      this.renderer.setPixelRatio(o),
      (this.perspCamera.aspect = e / n),
  ...
  setFov(e) {
    (this.perspCamera.fov = e), this.perspCamera.updateProjectionMatrix();
  }
  onBeforeDestroy() {
    this.options.appendTo.removeChild(this.renderer.domElement),
  ...
  static getRenderer() {
    return v.instance.renderer;
  }
};
let P = v;
t(P, "instance"), t(P, "renderer");
export { P as R };
